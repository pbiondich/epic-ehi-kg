...
| 2 | `LINE` | INTEGER | PK | Counts the line in a single prepayment note. The PREPAY_NOTES column contains the text the note for a single line. |
...
| 5 | `PREPAY_NOTES` | VARCHAR |  | User entered notes describing a pre-payment |

# FIN_ASST_CASE_ASSET_DOCS

> Table of documents linked to an asset on a financial assistance case.
...
| 4 | `DOCUMENT_ID` | VARCHAR | shared | Documents associated with an asset. |

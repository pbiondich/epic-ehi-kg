...
> Service line level action codes received in claims reconciliation.
...
|--:|--------|------|-------|-------------|
| 1 | `CLAIM_RECON_ID` | VARCHAR | PK | The unique identifier for the claims reconciliation record. |
...
| 6 | `LN_ACTION_CODE_C_NAME` | VARCHAR | org | This stores the received line level action code. |

# AP_CLAIM_IF_SVC_GRP_CLNPX

> This table contains the Clinical Procedure Console Flag returned from the third party interface.
...
| 5 | `CLINICAL_PX_CONSOLE_FLAG` | VARCHAR |  | The Clinical Procedure Console Flag returned from the third party interface. |

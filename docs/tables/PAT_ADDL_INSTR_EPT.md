...
> This table contains a single column for patient additional instructions. Since 2010 this item is no longer used, but records from before 2010 might still have this item populated.
...
| 6 | `INST_PAT_ADDL` | VARCHAR |  | As of Epic 2010, this item is no longer used to store the text of patient instructions. Patient instructions created prior to upgrade to Epic 2010 might still appear in this item. |

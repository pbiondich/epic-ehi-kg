# MED_CVG_ALERTS_DETAILS

> This table extracts the coverage response reason code for medication estimates.
...
| 6 | `CVG_ALERT_EXT_CODE_LST_ID` | NUMERIC |  | This item holds the detailed coverage alert reason code. |
| 7 | `CVG_ALERT_EXT_CODE_LST_ID_EXT_CODE_LST_NAME` | VARCHAR |  | The name of the list value. |

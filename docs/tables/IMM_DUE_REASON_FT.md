...
> This table extracts the related multiple response Imm Due - Reason Recommended - Free Text (I DXR 4141) item.
...
| 6 | `IMM_DUE_REASON_FT` | VARCHAR |  | Immunization due - Reason recommended - Free text |

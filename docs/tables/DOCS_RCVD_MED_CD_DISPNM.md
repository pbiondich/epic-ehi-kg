# DOCS_RCVD_MED_CD_DISPNM

> This table stores the display name of all the mapping codes for one medication reference ID.
...
| 6 | `DISPLAY_NAME` | VARCHAR |  | The display names of all the mapping codes for one medication reference ID |

...
> This table contains location restrictions placed on a financial assistance tracker record to limit the scope of its approval.
...
| 3 | `RESTR_LOC_ID_LOC_NAME` | VARCHAR |  | The name of the revenue location. |

...
> This table extracts the history of comments associated with deselecting recommended child order items.
...
| 6 | `CHILD_REC_CMT_HX` | VARCHAR |  | The reason for deselecting the recommended child order item. |

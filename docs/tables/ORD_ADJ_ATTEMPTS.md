...
> Adjudication attempts on prescription fill requests.
...
| 6 | `ADJ_ATTEMPT_ID` | NUMERIC |  | The unique identifier for the adjudication record attempts on this prescription fill request. |

# DOCS_RCVD_RAD_CD_DISPNM

> This table stores the display name of all the mapping codes for one risk adjustment category reference ID.
...
| 6 | `RAD_CODES_DISP_NAM` | VARCHAR |  | The display names of all the mapping codes for one risk adjustment category. |

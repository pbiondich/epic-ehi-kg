# AP_CLAIM_IF_PX_EDIT_DESC

> This table contains the description of the procedure edit returned from the third party interface.
...
| 5 | `PX_EDIT_DESCRIPTION` | VARCHAR |  | The description of the procedure edit. |

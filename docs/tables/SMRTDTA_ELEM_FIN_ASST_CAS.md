...
| 2 | `FIN_ASST_CASE_ID` | NUMERIC | FK→ | The unique ID of the linked finacial assistance case record that is associated with the SmartData element value. |

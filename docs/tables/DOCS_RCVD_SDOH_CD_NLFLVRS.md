# DOCS_RCVD_SDOH_CD_NLFLVRS

> This table extracts the code nullflavors for external social driver of health entries.
...
| 6 | `SDOH_NULLFLAVOR_C_NAME` | VARCHAR |  | This item stores the nullflavors associated with a social driver entry. |

# CUST_SERV_LETTER_TEXT_P5

> This table contains part 5 of the contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_5` | VARCHAR |  | Contains plain text of part 5 of the document. |

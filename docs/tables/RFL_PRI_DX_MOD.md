...
| 3 | `PRIMARY_DX_MOD_ID` | VARCHAR |  | Stores the modifiers or add-codes associated with the referral diagnosis. |
| 4 | `PRIMARY_DX_MOD_ID_MODIFIER_NAME` | VARCHAR |  | The name of the modifier record. |

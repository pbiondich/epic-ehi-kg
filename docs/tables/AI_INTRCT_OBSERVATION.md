# AI_INTRCT_OBSERVATION

> An observation made by the AI, likely of its environment.

**Primary key:** `AI_INTRCT_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 5
...
| 5 | `ENTITY_OBSERVATION` | VARCHAR |  | An observation made by the AI, likely of its environment. |

...
| 4 | `DX_AFF_HAC_ADJ_ROM` | VARCHAR |  | How the diagnosis affected the Hospital Acquired Condition (HAC)-adjusted Risk of Mortality (ROM) assignment. |

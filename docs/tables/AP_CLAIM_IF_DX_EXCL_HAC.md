...
| 4 | `DX_EXCL_HAC_GRPING` | VARCHAR |  | Indicates whether the diagnosis code was excluded from hospital-acquired condition (HAC)-adjusted grouping. |

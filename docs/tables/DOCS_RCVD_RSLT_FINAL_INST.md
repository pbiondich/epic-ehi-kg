# DOCS_RCVD_RSLT_FINAL_INST

> This table extracts the related multiple response Result Finalizing Instant (I DXR 5035) item.
...
| 6 | `RSLT_FINAL_INST_UTC_DTTM` | DATETIME (UTC) |  | This item stores the finalizing instant of the result. |

# DOCS_RCVD_CTM_PROV_IDS

> Contains the external provider IDs used to link a Care Team member to provider information.
...
| 6 | `CTM_PROV_ID` | VARCHAR |  | The id of the provider details related to this care team member. |

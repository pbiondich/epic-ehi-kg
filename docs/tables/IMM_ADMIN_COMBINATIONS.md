...
> This table extracts the related multiple response Imm Combinations (I DXR 4210) item.
...
| 6 | `IMM_COMBINATIONS_ID` | NUMERIC |  | If the immunization is a combination, this field contains the discrete combination immunization information. |
| 7 | `IMM_COMBINATIONS_ID_NAME` | VARCHAR |  | The name of the immunization. |

# SVC_PROV_RVW_PREF_FAC

> This table contains information about the facility (EAF) records marked as preferred during the patient's review of lists of post-discharge service providers sent to them by their case manager.
...
| 6 | `REV_PREF_FACILITY_ID_LOC_NAME` | VARCHAR |  | The name of the revenue location. |

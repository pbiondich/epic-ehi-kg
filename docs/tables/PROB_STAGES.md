...
> List of stages attached to a specific problem on a patient's Problem List.
...
| 3 | `CANCER_STAGE_ID` | NUMERIC |  | Stores a list of active stages associated with this problem. |

# DOCS_RCVD_RESRC_EMAILS

> This table stores the email address(es) of the community resource being used.
...
| 6 | `COMMUNITY_RESRC_EMAIL_ADDRESS` | VARCHAR |  | This column stores the email address(es) of the community resource being used. |

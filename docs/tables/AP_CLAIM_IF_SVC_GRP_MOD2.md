# AP_CLAIM_IF_SVC_GRP_MOD2

> This table contains edits returned from the third party interface for the second modifier.
...
| 5 | `MODIFIER_2_EDIT` | VARCHAR |  | The edit descriptions returned from the third party interface for the second modifier. |

# COD_RSN_FOR_VST_SRC_REF

> Source information about the reason for visit value. Corresponds to line numbers in the source table.

**Primary key:** `CODING_RECORD_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 5

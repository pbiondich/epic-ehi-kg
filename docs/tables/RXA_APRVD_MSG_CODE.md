...
> Stores approved message codes for an adjudication. Approved message codes may be used by payors to indicate that additional follow-up is needed. Adjudication records are used by Ambulatory Pharmacy during prescription copay adjudication.
...
| 6 | `APPROVED_MESSAGE_C_NAME` | VARCHAR |  | NCPDP code, on an approved claim/service, communicating the need for an additional follow-up. |

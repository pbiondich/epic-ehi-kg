# DOCS_RCVD_RSLTS_SIGN_INST

> This table extracts the related multiple response Result Signed Instant (I DXR 5033) item.
...
| 6 | `RSLT_SIGN_INST_UTC_DTTM` | DATETIME (UTC) |  | This item stores the signed instant of the result. |

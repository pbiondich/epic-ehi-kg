...
> Clarity table for related-multi item EPT 88402, which contains comments for why a specimen pre-order was not collected.
...
| 7 | `ORD_SPEC_PREORD_NC` | VARCHAR |  | Stores comments for specimen pre-orders that have been documented as "Not Collected" in EPT 88401. |

# QRY_EVIDENCE_LQL_ANSWERS

> This table extracts information related to the Textractor answers for this evidence.

**Primary key:** `QUERY_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 6
...
| 6 | `EVIDENCE_LQL_ANSWER` | VARCHAR |  | The Textractor answer that the evidence supports. |

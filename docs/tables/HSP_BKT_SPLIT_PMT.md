...
> This table contains split payment distribution information by coverage for liability buckets.
...
| 3 | `SPLIT_PMT_DIST_CVG` | VARCHAR |  | The split payment distribution information by coverage for the given bucket. |

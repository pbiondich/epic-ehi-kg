...
> This table stores MyChart information on history questionnaires assigned to a patient.
...
| 6 | `HX_QNR_STATUS_C_NAME` | VARCHAR |  | Stores the status of a history questionnaire assigned to the patient. |

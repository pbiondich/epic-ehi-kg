# CUST_SERV_LETTER_TEXT_P3

> This table contains part 3 of the contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_3` | VARCHAR |  | Contains plain text of part 3 of the document. |

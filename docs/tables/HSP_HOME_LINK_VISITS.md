...
| 6 | `HSP_ACCOUNT_ID` | NUMERIC | FK→ | The hospital account ID for a Hospital at Home linked visit |
...
| 8 | `START_UTC_DTTM` | DATETIME (UTC) |  | The start instant for a Hospital at Home linked visit |
| 9 | `END_UTC_DTTM` | DATETIME (UTC) |  | The end instant for a Hospital at Home linked visit |
| 10 | `VISIT_TYPE_ID_PRC_NAME` | VARCHAR |  | The name of the visit type. |

...
> This table stores the staff who were present during timeout.
...
| 6 | `STAFF_PRES_STAFF_ID_PROV_NAME` | VARCHAR |  | The name of the service provider. This item may be hidden in a public view of the CLARITY_SER table. |

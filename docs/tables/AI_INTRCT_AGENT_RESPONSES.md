# AI_INTRCT_AGENT_RESPONSES

> Contains information about agent workflow responses.
...
| 4 | `AGENT_RESPONSE` | VARCHAR |  | Stores the responses returned from the generic agent framework. |

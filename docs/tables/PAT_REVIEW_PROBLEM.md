...
| 6 | `PAT_REVIEW_LPL_ID` | NUMERIC |  | Patient problem reviewed by patient. |
| 7 | `PAT_REVIEW_LPL_R_YN` | VARCHAR |  | Patient problem reviewed by patient response. |
| 8 | `PAT_REV_LPL_EXTERN` | VARCHAR |  | Patient problems reviewed by the patient, entered in a free text format. |

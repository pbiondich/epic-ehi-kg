...
> This table contains the visit level questionnaire answers collected for a visit at End Procedure.
...
| 3 | `LINE` | INTEGER | PK | The line number for answers given for visit questionnaires when ending a procedure associated with this record. Multiple pieces of information can be associated with this record. |
| 4 | `CONTACT_DATE` | DATETIME |  | The date of this contact in calendar format. |
| 5 | `END_PROC_ANS_ID` | VARCHAR |  | The unique ID of the visit level questionnaire answer given while ending a procedure. |

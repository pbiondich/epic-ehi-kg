# IB_MESSAGES_CLAIM_LETTERS

> Stores the items that are used for claim letters.
...
| 3 | `CLAIM_ID` | NUMERIC | FK→ | Stores the list of claims related to the InBasket message. |

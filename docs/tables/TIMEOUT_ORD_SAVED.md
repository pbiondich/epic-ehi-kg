...
> This table contains the current saved instant of the medication administration of the order in the row.
...
| 6 | `VERIF_SAVED_IN_DTTM` | DATETIME (UTC) |  | The saved instant of the order that the provider signed off. |

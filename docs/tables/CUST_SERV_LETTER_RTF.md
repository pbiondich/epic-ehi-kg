# CUST_SERV_LETTER_RTF

> This table contains the Rich Text Format (RTF) content of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_RTF` | VARCHAR |  | Contains Rich Text of part 1 of the document. |

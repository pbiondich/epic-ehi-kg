# AP_CLAIM_IF_SVC_GRP_PXED

> This table contains the Procedure Edit value returned from the third party interface.
...
| 5 | `PX_EDIT` | VARCHAR |  | The Procedure Edit value returned from the third party interface. |

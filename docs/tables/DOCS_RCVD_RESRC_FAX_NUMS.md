# DOCS_RCVD_RESRC_FAX_NUMS

> This table stores the fax numbers of a particular community resource usage.
...
| 6 | `COMMUNITY_RESRC_FAX_NUM` | VARCHAR |  | This column stores the fax number(s) of the community resource being used. |

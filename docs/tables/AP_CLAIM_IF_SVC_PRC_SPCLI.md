# AP_CLAIM_IF_SVC_PRC_SPCLI

> This table contains Item Procedure Special Payment Indicator value returned from the third party interface.
...
| 5 | `ITEM_PX_SPECIAL_PAYMENT_IND` | VARCHAR |  | The Item Procedure Special Payment Indicator value returned from the third party interface. |

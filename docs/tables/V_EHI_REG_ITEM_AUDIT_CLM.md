# V_EHI_REG_ITEM_AUDIT_CLM

> Claim record audit events. This view contains audit information for claim records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, REG_ITEM_AUDIT_CLM and REG_ITEM_AUDIT_LINES_CLM should be used instead.
...
| 5 | `CLAIM_ID` | NUMERIC | FK→ | Claim that was changed in this audit event. |

# HSP_BFH_BILL_RANGE_CVG

> Stores the coverage used when billing a range inside a billing activity.
...
| 4 | `ACT_BILL_COVERAGE_ID` | NUMERIC |  | Holds the coverage for a billing date range |

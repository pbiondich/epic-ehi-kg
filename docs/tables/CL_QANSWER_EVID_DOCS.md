# CL_QANSWER_EVID_DOCS

> The documents serving as evidence to the question response.
...
| 4 | `DOCUMENT_ID` | VARCHAR | shared | The documents serving as evidence to the question response. |

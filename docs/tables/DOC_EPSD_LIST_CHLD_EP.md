# DOC_EPSD_LIST_CHLD_EP

> Contains child episodes for the received episode.
...
| 6 | `EPSD_CHILD_EPISODE_IDENTIFIER` | VARCHAR |  | The episode identifiers for child episodes. This maps to values stored in I DXR 8510. |

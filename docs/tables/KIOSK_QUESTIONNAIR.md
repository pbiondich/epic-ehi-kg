...
| 6 | `KIOSK_QUEST_ID` | VARCHAR |  | The unique ID of the questionnaire assigned to the encounter, which will be presented to the patient at the Welcome kiosk. |
| 7 | `KIOSK_QUEST_ID_FORM_NAME` | VARCHAR |  | The name of the form associated with the questionnaire. |

# AUTH_REQUEST_HX_COMMS

> This table contains the communications associated with the authorization request.
...
| 4 | `COMM_ID` | VARCHAR | shared | The unique ID of the communication associated with the authorization request. |

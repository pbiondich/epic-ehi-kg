...
| 2 | `LINE` | INTEGER | PK | The line count for this table as determined by the number of preliming radiologists for an order. |
...
| 4 | `PRELIM_DT` | DATETIME |  | The date when the provider marked the study as preliminary. |

# CHAT_MSG_OTHER_SNAPSHOT

> Table for PHI other snapshot information in Secure Chat.
...
| 6 | `OTHER_SS` | VARCHAR |  | Other snapshot data of the order or saved work linked to this message |

...
> The PAT_ENC_APPT_DX table contains a list of diagnoses associated with appointments that were manually entered by a user on the "Clinical Information" form, which can appear in Advantage Activities in Check In, Check Out, Appointment Information, or After Appointment Entry, depending on your configuration.

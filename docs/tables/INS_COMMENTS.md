...
> Informational comments about a payor on a patient contact.
...
| 6 | `INS_COMMENTS` | VARCHAR |  | These comments are for display only. They are informational comments about each payor. |

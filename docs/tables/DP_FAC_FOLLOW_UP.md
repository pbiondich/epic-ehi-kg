...
> This table contains the follow-ups describing why a service request for continued care or services is being considered.
...
| 4 | `DP_FAC_FOLLOW_UP_C_NAME` | VARCHAR | org | The category ID of the follow-up for a service provider that is considering the patient. |

# CUST_SERV_LETTER_TEXT_P4

> This table contains part 4 of the contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_4` | VARCHAR |  | Contains plain text of part 4 of the document. |

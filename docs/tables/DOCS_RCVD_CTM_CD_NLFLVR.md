# DOCS_RCVD_CTM_CD_NLFLVR

> This table stores the nullFlavor values of all the mapping codes for one care team member reference ID.
...
| 6 | `CODE_NULLFLAVOR_C_NAME` | VARCHAR |  | The nullflavors of all the codes for one care team reference ID |

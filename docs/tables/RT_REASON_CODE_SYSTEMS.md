# RT_REASON_CODE_SYSTEMS

> This table extracts the related multiple response item ERT-311.
...
| 5 | `REASON_SYSTEM` | VARCHAR |  | Stores the system for the code in ERT 310 indicating why radiation therapy was prescribed or used. |

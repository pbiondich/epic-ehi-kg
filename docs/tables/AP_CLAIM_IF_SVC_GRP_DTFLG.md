# AP_CLAIM_IF_SVC_GRP_DTFLG

> This table contains the Service Date Edit To From Date Flag value returned from the third party interface.
...
| 5 | `SERVICE_TO_FROM_DATE_FLAG` | VARCHAR |  | The Service Date Edit To From Date Flag value returned from the third party interface. |

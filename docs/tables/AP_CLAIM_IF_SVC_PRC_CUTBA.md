# AP_CLAIM_IF_SVC_PRC_CUTBA

> This table contains the service line Cutback Amount value returned from the third party interface.
...
| 5 | `CUTBACK_AMOUNT` | VARCHAR |  | The service line Cutback Amount value returned from the third party interface. |

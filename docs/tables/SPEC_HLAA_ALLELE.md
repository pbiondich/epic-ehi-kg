...
> This table stores HLA-A genotype information for a platelet product.
...
| 4 | `HLAA_ALLELE_C_NAME` | VARCHAR |  | Stores HLA-A genotype information for a platelet product. |

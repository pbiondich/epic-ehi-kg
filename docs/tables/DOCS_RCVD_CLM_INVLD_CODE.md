# DOCS_RCVD_CLM_INVLD_CODE

> This table extracts the related multiple response item DXR-22652.
...
| 5 | `INVLD_CODE` | VARCHAR |  | Holds the code that caused this claim to be marked invalid. |

...
> This table contains information on the MyChart patient note audit trail.
...
| 5 | `MYC_NOTE_USER_ID` | VARCHAR |  | ID of user who created the MyChart note. |
| 6 | `MYC_NOTE_USER_ID_NAME` | VARCHAR |  | The name of the user record. This name may be hidden. |

...
| 3 | `IO_OCC_FSROW_IDS` | VARCHAR |  | Flowsheet rows that can be used for IO occurrence documentation. For duplicable rows, the identifier used to distinguish among multiple rows is stored in OCCURRENCE. |

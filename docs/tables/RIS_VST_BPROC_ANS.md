...
> This table contains the visit level questionnaire answers collected for a visit at Begin Procedure.
...
| 3 | `LINE` | INTEGER | PK | The line number for visit level questionnaire answers given when beginning a procedure. Multiple pieces of information can be associated with this contact. |
| 4 | `CONTACT_DATE` | DATETIME |  | The date of this contact in calendar format. |
| 5 | `BEGIN_PROC_ANS_ID` | VARCHAR |  | The unique ID of the visit level questionnaire answer given when beginning a procedure. |

...
> Stores billing activity history of transactions added to billing collections.
...
| 4 | `COLL_PB_ACT_TX_ID` | VARCHAR |  | Stores billing activity history of transactions added to collections. |

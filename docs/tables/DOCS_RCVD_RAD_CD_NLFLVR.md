# DOCS_RCVD_RAD_CD_NLFLVR

> This table stores the nullFlavor values of all the mapping codes for one risk adjustment category reference ID.
...
| 6 | `RAD_CODES_NF_C_NAME` | VARCHAR |  | The nullFlavor values of all the mapping codes for one risk adjustment category. |

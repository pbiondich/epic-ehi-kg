...
| 6 | `ECHKIN_WARNING_C_NAME` | VARCHAR |  | This stores a warning message that occurred during the eCheck-In. |
| 7 | `GUAR_ACCOUNT_ID` | NUMERIC |  | This item contains the guarantor account ID related to the guarantor verification warning in eCheck-In. |

# AP_CLAIM_IF_SVC_GRP_AGDSC

> This table contains the Agency Edit descriptions returned from the third party interface.
...
| 5 | `AGENCY_EDIT_DESC` | VARCHAR |  | The Agency Edit descriptions returned from the third party interface. |

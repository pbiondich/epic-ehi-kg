...
> This table contains information pertaining to how specific users are accessing specific home care forms, such as how long a user has spent in a given form.

# AP_CLAIM_IF_SVC_PRC_TOTOU

> This table contains the Total Excluded Outlier Payment value returned from the third party interface.
...
| 5 | `TOTAL_EXCL_OUTLIER_PMT` | VARCHAR |  | The Total Exluded Outlier Payment value returned from the third party interface. |

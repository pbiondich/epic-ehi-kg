# ORD_NLP_VERIF_LUNG_RECOM

> This table contains information about lung screening recommendations that were present on orders when the output from a natural language processing model to extract lung screening information was verified or last modified.

...
> Transplant committee review absolute contraindications.
...
| 6 | `TXP_ABS_CIND_C_NAME` | VARCHAR | org | Absolute contraindications, which cause a transplant patient to be denied a transplant. |

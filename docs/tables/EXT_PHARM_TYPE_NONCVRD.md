...
> The non-covered pharmacy coverage type returned from Surescripts eligibility response.
...
| 4 | `NONCVRD_EXTERNAL_PHARM_TYPE_C_NAME` | VARCHAR |  | Stores non-covered pharmacy coverage type for Surescripts |

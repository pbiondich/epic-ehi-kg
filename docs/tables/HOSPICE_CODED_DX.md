...
| 6 | `HOSPICE_CODED_DX_ID_DX_NAME` | VARCHAR |  | The name of the diagnosis. |
| 7 | `HOSPICE_RELATED_C_NAME` | VARCHAR |  | Indicates if the corresponding hospice diagnosis is related to terminal illness |

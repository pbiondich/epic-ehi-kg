# V_EHI_REG_ITEM_AUDIT_HAR

> Visit account record audit events. This view contains audit information for visit account records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, REG_ITEM_AUDIT_HAR and REG_ITEM_AUDIT_LINES_HAR should be used instead.
...
| 5 | `HSP_ACCOUNT_ID` | NUMERIC | FK→ | Visit account that was edited in this audit event. |

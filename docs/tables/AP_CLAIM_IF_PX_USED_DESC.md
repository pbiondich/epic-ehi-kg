# AP_CLAIM_IF_PX_USED_DESC

> This table contains the description of the procedure used returned from the third party interface.
...
| 5 | `PX_USED_DESCRIPTION` | VARCHAR |  | The description of the procedure used. |

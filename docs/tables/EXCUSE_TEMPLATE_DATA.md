...
> The EXCUSE_TEMPLATE_DATA table contains information about the answers to questions (LQL records) from a disposition workspace excuses letter template.
...
| 6 | `EXCUSE_LQL_DATA` | VARCHAR |  | Answers to questions for the excuse template. |

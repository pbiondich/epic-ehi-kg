# QRY_EVIDENCE_EXCERPT_TEXT

> This table extracts information related to the note citations that the evidence came from.
...
| 6 | `EVID_EXCERPT` | VARCHAR |  | The excerpt of text from the document. |

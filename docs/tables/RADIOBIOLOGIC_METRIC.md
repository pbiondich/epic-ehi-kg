# RADIOBIOLOGIC_METRIC

> Radiobiologic effective dose metrics defined by TG-263.
...
| 6 | `RADIOBIOLOGIC_METRIC_C_NAME` | VARCHAR |  | Stores radiobiologic effective dose metrics defined by TG-263. |

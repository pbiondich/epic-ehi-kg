# DP_SEL_CNCT_PT_PURPOSE

> The category IDs of the purpose or purposes of an encounter-specific contact point associated with a post-acute facility or agency. A contact point contains a name, purposes, phone and fax and can be selected on the Contact Points popup in CCSC.
...
| 7 | `SVC_PROV_CNCT_PURPOSE_C_NAME` | VARCHAR | org | The category IDs of the purpose or purposes of the user-selected encounter-specific contact point. |

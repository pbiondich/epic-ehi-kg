# DOCS_RCVD_CLM_INVLD_TYPE

> This table extracts the related multiple response item DXR-22651.
...
| 5 | `INVLD_CODE_TYP` | VARCHAR |  | Holds the type of the code that caused this claim to be marked invalid. |

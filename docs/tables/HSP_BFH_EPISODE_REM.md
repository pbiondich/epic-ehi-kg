...
> The list of episodes that were removed from this account while this action was taken.
...
| 4 | `ACTS_REM_EPISODE_ID` | NUMERIC |  | Lists the episodes that were removed from the account as a result of the action. |

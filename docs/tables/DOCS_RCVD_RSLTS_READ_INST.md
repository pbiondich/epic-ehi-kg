# DOCS_RCVD_RSLTS_READ_INST

> This table extracts the related multiple response Result Read Instant (I DXR 5037) item.
...
| 6 | `RSLT_READ_INST_UTC_DTTM` | DATETIME (UTC) |  | This item stores the reading date of the result. |

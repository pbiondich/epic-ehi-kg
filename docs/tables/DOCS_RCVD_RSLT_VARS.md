...
> This table extracts the related multiple response Reconciled Variant Info (I DXR 45003) item.
...
| 5 | `RECON_VARIANT_ID` | NUMERIC |  | The Variant IDs for the variants pertaining to a result |

# SPOC_PART_HSPC_DISCIPLINE

> This table contains the hospice disciplines of participants on a hospice plan of care.

**Primary key:** `POC_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 6  
...
| 6 | `PART_HSPC_DISCIPLINE_C_NAME` | VARCHAR | org | The home health/hospice discipline category ID for the provider. |

# DOCS_RCVD_RESRC_CD_NLFLVS

> This table stores the nullflavors for the codes for a community resource usage.
...
| 6 | `COMM_RESRC_USAGE_NULLFLAVOR_C_NAME` | VARCHAR |  | Stores the code nullflavors for a community resource usage. |

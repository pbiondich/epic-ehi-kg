# V_EHI_REG_ITEM_AUDIT_EAR

> Guarantor record audit events. This view contains audit information for guarantor records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, REG_ITEM_AUDIT_EAR and REG_ITEM_AUDIT_LINES_EAR should be used instead.
...
| 5 | `ACCT_ID` | NUMERIC | shared | Guarantor that was changed in this audit event. |

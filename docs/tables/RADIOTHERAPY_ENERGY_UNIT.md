# RADIOTHERAPY_ENERGY_UNIT

> This table extracts the related multiple response item ERT-621.
...
| 5 | `BEAM_ENERGY_UNIT_C_NAME` | VARCHAR |  | Stores the unit of the associated energy. |

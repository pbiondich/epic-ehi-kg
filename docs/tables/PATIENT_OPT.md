...
> The PATIENT_OPT table contains optional patient information.
...
| 2 | `PERM_CLINIC_AREA_C_NAME` | VARCHAR | org | The permanent clinic area category number for the patient. |

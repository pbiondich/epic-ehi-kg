# LCI_HEDIS_PLAN_BENEFITS

> Clarity table for the HEDIS plan benefits related multiple item in LCI.

**Primary key:** `EXTERNAL_CVG_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 5
...
| 5 | `HEDIS_BENEFITS_C_NAME` | VARCHAR |  | The NCQA HEDIS plan benefits of an external coverage contact. |

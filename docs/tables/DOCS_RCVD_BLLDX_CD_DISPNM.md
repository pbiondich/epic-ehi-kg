# DOCS_RCVD_BLLDX_CD_DISPNM

> This table stores the display name of all the mapping codes for one billing diagnosis reference ID.
...
| 6 | `DISPLAY_NAME` | VARCHAR |  | The display names of all the mapping codes for one billing diagnosis reference ID |

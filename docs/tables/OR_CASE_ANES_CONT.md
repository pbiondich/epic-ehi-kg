...
> The OR_CASE_ANES_CONT table contains OR management system case anesthesia contingencies.
...
| 2 | `LINE` | INTEGER | PK | The number of the line of the anesthesia contingencies for this case. |

...
> The names or numbers of any additional agencies that should receive a copy of the results report for this specimen.
...
| 4 | `AGENCY_ID_RRROUTE_NAME` | VARCHAR |  | The name of the Result Report Routing. |

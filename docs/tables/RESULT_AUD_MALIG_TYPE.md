...
| 3 | `VALUE_LINE` | INTEGER | PK | The line number of one of the multiple malignancy types that are associated with the finding audit information from the RESULT_AUDIT table. |
| 4 | `MALIGNANCY_TYPE_C_NAME` | VARCHAR | org | The malignancy type category ID, if any, for the action being audited. |

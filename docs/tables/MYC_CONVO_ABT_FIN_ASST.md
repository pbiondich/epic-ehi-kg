# MYC_CONVO_ABT_FIN_ASST

> Financial assistance cases associated with the MyChart message conversation.
...
| 3 | `FIN_ASST_CASE_ID` | NUMERIC | FK→ | Financial assistance case for this thread. |

...
> Table containing contacts for secure chat conversations.

**Primary key:** `CONVERSATION_ID`, `CONTACT_DATE_REAL`  
**Columns:** 8
...
| 4 | `CONVERSATION_CSN_ID` | NUMERIC |  | The contact serial number (CSN) of the contact. |
...
| 7 | `CHAT_CNCT_TYPE_C_NAME` | VARCHAR |  | Stores the contact type for this database |

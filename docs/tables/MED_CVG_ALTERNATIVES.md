...
| 5 | `ALT_ERX_ID_MEDICATION_NAME` | VARCHAR |  | The name of this medication record. |
| 6 | `ALT_CVG_ID` | NUMERIC |  | Holds the ID of the medication estimate (LME) record that has coverage details for the payer-suggested alternative. |

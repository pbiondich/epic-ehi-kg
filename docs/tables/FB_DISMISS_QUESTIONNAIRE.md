# FB_DISMISS_QUESTIONNAIRE

> The FB_DISMISS_QUESTIONNAIRE table contains the MyChart accounts (I EPT 29776) that have dismissed a feedback questionnaire (I EPT 29775) on the home feed.

# DOCS_RCVD_RSLTS_PROC_LNKS

> This table stores links to discrete procedures from discrete results received from outside sources.
...
| 6 | `RESULT_LINKED_PROC_IDENT` | VARCHAR |  | The reference IDs for the procedure entries this result is associated with |

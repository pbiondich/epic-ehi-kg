# AP_CLAIM_IF_SVC_PRC_PROCF

> This table contains Procedure Fee value returned from the third party interface.
...
| 5 | `PX_FEE` | VARCHAR |  | The Procedure Fee value returned from the third party interface. |

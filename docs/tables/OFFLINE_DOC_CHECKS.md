...
> Details from offline documentation checks. This table includes the non related multiline items such as offline check type and the time when this offline check was stored.

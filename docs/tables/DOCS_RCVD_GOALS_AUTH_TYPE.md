# DOCS_RCVD_GOALS_AUTH_TYPE

> This table extracts the related multiple response Goal Author Type (I DXR 19006) item.
...
| 6 | `GOAL_AUTHOR_TYPE_C_NAME` | VARCHAR |  | This item stores the goal author's type. |

# RECONCILE_SVC_INFO_REQ_CD

> This table extracts the related multiple response Line Information Request Code (I CRD 364) item.
...
| 6 | `LN_INFO_REQ_CODE` | VARCHAR |  | This is the code that defines the additional information being requested. |

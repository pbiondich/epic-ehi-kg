# AP_CLAIM_IF_SVC_PRC_ALTP

> This table contains the alternate payment value returned from the third party interface.
...
| 5 | `ALTERNATE_PAYMENT` | VARCHAR |  | The alternate payment value returned from the third party interface. |

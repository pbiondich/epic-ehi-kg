...
> The history of stop bills removed from a hospital account.
...
| 4 | `RMV_STOP_BILL_RSN_C_NAME` | VARCHAR | org | Contains the history of stop bills removed from an account. |

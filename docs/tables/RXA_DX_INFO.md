...
| 5 | `DX_CODE_QUALIFIER_C_NAME` | VARCHAR |  | NCPDP code qualifying the value in the Diagnosis code field 424-DO. (492-WE) |
| 6 | `DX_CODE` | VARCHAR |  | The code that identifies the diagnosis of the patient. (424-DO) |

...
> This table extracts the IDs of the results records that store information about the findings recorded by the technologist in the Procedure Log.
...
| 6 | `PLOG_FINDING_ID` | NUMERIC |  | The results/findings documented by the technologist in the Procedure Log that are associated with the related findings group. |

# DIA_CMS_START_NHPI_RACE

> This table contains patients' Native Hawaiian or Other Pacific Islander racial identities as submitted for CMS ESRD patient registration forms (CMS-2728).

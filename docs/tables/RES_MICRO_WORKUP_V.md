...
| 3 | `VALUE_LINE` | INTEGER | PK | The line number of one of the multiple values that are associated with the line from the RES_MICRO_WORKUP table. |
| 4 | `WORKUP_VALUE` | VARCHAR |  | Component values for each line and workup. |

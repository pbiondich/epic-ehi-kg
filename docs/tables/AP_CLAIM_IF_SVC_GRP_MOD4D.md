# AP_CLAIM_IF_SVC_GRP_MOD4D

> This table contains edit descriptions returned from the third party interface for the fourth modifier.
...
| 5 | `MODIFIER_4_EDIT_DESC` | VARCHAR |  | The edit descriptions returned from the third party interface for the fourth modifier. |

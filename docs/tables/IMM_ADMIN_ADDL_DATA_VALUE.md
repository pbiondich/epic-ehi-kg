# IMM_ADMIN_ADDL_DATA_VALUE

> The table contains the value of additional administration data from an external immunization.
...
| 6 | `IMM_ADDTNDATA_VALUE` | VARCHAR |  | Stores the parsed string value of the additional immunization admin data element received from an external source. The category of the data element is stored in the corresponding line in I DXR 4270. |

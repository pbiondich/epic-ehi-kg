...
| 4 | `LN_ADJ_REV_CD` | VARCHAR |  | This item holds the revenue code for the line level adjudication segment in American National Standards Institute electronic institutional claims. |

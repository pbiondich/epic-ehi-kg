# DOCS_RCVD_RESRCSVC_CD_NMS

> This table stores the display names for the codes compiled for a particular service recommended at a community resource.
...
| 6 | `COMM_RESRC_SVC_CD_DISP_NAME` | VARCHAR |  | Stores the display names of codes for a community resource service recommended. |

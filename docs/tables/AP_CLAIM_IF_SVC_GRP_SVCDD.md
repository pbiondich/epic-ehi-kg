# AP_CLAIM_IF_SVC_GRP_SVCDD

> This table contains Service Date Edit Description value returned from the third party interface.
...
| 5 | `SERVICE_DATE_EDIT_DESC` | VARCHAR |  | The Service Date Edit Description value returned from the third party interface. |

...
| 3 | `VALUE_LINE` | INTEGER | PK | The line number of one of the multiple modifiers associated with a specific diagnosis within this contact. |
...
| 6 | `DDX_MODIFIER_TYPE_C_NAME` | VARCHAR | org | Stores the types of selected modifiers when a diagnosis is copied from the problem list, for example the laterality or chronicity of a problem. |

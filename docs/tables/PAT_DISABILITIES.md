...
> Contains information about patient-reported disabilities.
...
| 6 | `PAT_DISABILITIES_C_NAME` | VARCHAR | org | The disability status category ID for the patient. |
| 7 | `PAT_DISABILITIES_RESP_C_NAME` | VARCHAR | org | The disability status response category ID for the patient. |

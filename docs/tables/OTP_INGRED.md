...
> This table extracts the related multiple response item Dose at Action - Ingredient (I OTP 8020).
...
| 4 | `ERX_ID_MEDICATION_NAME` | VARCHAR |  | The name of this medication record. |

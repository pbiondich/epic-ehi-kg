# DOCS_RCVD_TRT_VERIF_W_NAM

> This table extracts the related multiple response item DXR-43019.
...
| 6 | `TRT_VERIF_WITH_DISP` | VARCHAR |  | The display name of the code for the person with whom the treatment restriction has been discussed and verified |

...
| 4 | `AUDIT_LINKD_NOTE_ID` | VARCHAR |  | Stores the edited linked notes information. Stores the note record ID's of notes that are associated with this data through the flowsheet notes functionality. |

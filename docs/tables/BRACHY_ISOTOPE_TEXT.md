...
> Contains the free text representation of the radiotherapy isotope used for brachytherapy.
...
| 6 | `BRACHY_ISOTOPE_TEXT` | VARCHAR |  | Stores a free text representation of the isotopes used for brachytherapy. |

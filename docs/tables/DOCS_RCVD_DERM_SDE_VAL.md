# DOCS_RCVD_DERM_SDE_VAL

> Each row represents a value linked to a specific SmartData Element about a Dermatology QuickProcedure received from an external organization.

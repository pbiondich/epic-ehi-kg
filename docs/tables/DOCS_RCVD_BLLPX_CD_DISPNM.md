# DOCS_RCVD_BLLPX_CD_DISPNM

> This table stores the display name of all the mapping codes for one billing procedure reference ID.
...
| 6 | `DISPLAY_NAME` | VARCHAR |  | The display names of all the mapping codes for one billing procedure reference ID |

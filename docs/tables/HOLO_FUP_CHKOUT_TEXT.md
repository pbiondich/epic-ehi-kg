# HOLO_FUP_CHKOUT_TEXT

> This table contains follow-up checkout text stored in hologram records.
...
| 4 | `FUP_CHKOUT_TEXT` | VARCHAR |  | Check-out note entered by the provider for the follow-up. |

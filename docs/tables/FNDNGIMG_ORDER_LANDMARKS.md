# FNDNGIMG_ORDER_LANDMARKS

> This table extracts the information on landmark photodocumentation for an image on an order (ORD) record.
...
| 6 | `LANDMARK_PHOTODOC_C_NAME` | VARCHAR |  | The finding images landmark options category ID for this order. |

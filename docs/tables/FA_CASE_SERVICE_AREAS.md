# FA_CASE_SERVICE_AREAS

> This table contains the service areas covered by a financial assistance case.
...
| 3 | `FA_CASE_SERV_AREA_ID_LOC_NAME` | VARCHAR |  | The name of the revenue location. |

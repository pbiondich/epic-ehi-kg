# ORD_NLP_VERIFIED_FINDING

> This table contains information about findings that were present on orders when the output from a natural language processing model to extract findings was verified or last modified.

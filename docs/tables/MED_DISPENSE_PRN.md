...
> Clarity table for the Medication Dispense PRN Reasons, corresponding to related-multiple item I DXR 16280.
...
| 6 | `DISP_PRN_REASONS_C_NAME` | VARCHAR | org | Stores the PRN reasons for a PRN dispense |

# DOCS_RCVD_RESRC_CD_DSPNMS

> This table stores the display names for the codes for a particular community resource usage.
...
| 6 | `COMM_RESRC_CODE_DISPLAY_NAME` | VARCHAR |  | Stores the display names of codes for a community resource usage. |

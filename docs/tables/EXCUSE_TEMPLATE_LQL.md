...
> The EXCUSE_TEMPLATE_LQL table contains information about the questions (LQL records) that can be answered from a disposition workspace excuses letter template.
...
| 3 | `VALUE_LINE` | INTEGER | PK | The line number of one of the multiple question records associated with a specific group of data in this contact. |
...
| 6 | `EXCUSE_LQL_ID` | NUMERIC |  | The IDs of the specific questions that can be answered for the excuse template. |

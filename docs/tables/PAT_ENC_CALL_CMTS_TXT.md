# PAT_ENC_CALL_CMTS_TXT

> This table stores the free-text comments entered in Protocols during clinical calls.
...
| 7 | `PROTOCOL_CMT_TXT` | VARCHAR |  | Comment text left on a Nurse Triage Protocol by a triager. |

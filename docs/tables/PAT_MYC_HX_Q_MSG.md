...
> This table contains the history questionnaire messages associated with this encounter.
...
| 6 | `HX_QTNR_MSG_ID` | VARCHAR |  | The unique ID of the history questionnaire message associated with this encounter. |

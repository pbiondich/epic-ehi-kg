...
> The ORD_GROUP_COMMENTS table stores user comments for patient-level order groups.
...
|--:|--------|------|-------|-------------|
| 1 | `REGIMEN_ID` | NUMERIC | PK shared | The unique ID of the patient-specific order group. |
...
| 5 | `ORD_GROUP_COMMENTS` | VARCHAR |  | The user comments associated with this patient-level order group. |

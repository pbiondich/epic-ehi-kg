# DOCS_RCVD_TREAT_VERIFIED

> This table contains information about whether treatment restrictions have been verified.
...
| 6 | `TREAT_VERIFIED_YN` | VARCHAR |  | Indicates whether the treatment restriction has been verified |

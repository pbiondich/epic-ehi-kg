# V_EHI_REG_ITEM_AUDIT_FNC

> Financial assistance case audit events.This view contains audit information for financial assistance case records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, REG_ITEM_AUDIT_FNC and REG_ITEM_AUDIT_LINES_FNC should be used instead.
...
| 5 | `FIN_ASST_CASE_ID` | NUMERIC | FK→ | Financial assistance case that was changed in this audit event. |

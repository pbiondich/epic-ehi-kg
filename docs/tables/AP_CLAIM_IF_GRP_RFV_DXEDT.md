# AP_CLAIM_IF_GRP_RFV_DXEDT

> This table contains reason for visit (RFV) diagnosis edit value returned from the third party interface.
...
| 5 | `RFV_DX_EDIT` | VARCHAR |  | The RFV Diagnosis Edit value returned from the third party interface. |

...
> Transplant committee review relative contraindications.
...
| 6 | `TXP_REL_CIND_C_NAME` | VARCHAR | org | Relative contraindications, which either cause a transplant patient to be denied a transplant or require the patient to be re-evaluated later. |

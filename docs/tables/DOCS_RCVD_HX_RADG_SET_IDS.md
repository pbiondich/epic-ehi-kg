# DOCS_RCVD_HX_RADG_SET_IDS

> Contains the set IDs loaded for a particular set of demographics, for a particular effective date, for a particular set of external risk adjustment data.
...
| 6 | `HX_EX_SET_ID_RA_C_NAME` | VARCHAR | org | The Risk Adjustment set IDs that have loaded this particular set of demographics with this effective date. |

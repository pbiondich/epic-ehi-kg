...
> This table contains the reasons associated with a patient's risk of developing breast cancer.
...
| 6 | `MAM_RISK_C_NAME` | VARCHAR | org | The breast cancer - risk category ID for the order. |

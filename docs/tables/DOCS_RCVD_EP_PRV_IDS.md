# DOCS_RCVD_EP_PRV_IDS

> Contains external provider IDs used to link provider information to an episode provider.
...
| 6 | `EPSD_PROV_RELATED_PROV_ID` | VARCHAR |  | Stores multiple provider IDs used to link to the providers group in DXR 9000 and retrieve information about the provider (address, name, etc.) |

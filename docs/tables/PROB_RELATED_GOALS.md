...
> A list of goals (IGO records) that are related to the current problem.
...
|--:|--------|------|-------|-------------|
| 1 | `PROBLEM_LIST_ID` | NUMERIC | PK FK→ | The unique ID of this Problem List record. |
...
| 4 | `CONTACT_DATE` | DATETIME |  | The date of the contact in calendar format. |
| 5 | `RELATED_GOAL_ID` | VARCHAR |  | The list of patient goal IDs related to the current problem. |

# AP_CLAIM_IF_SVC_GRP_VISMF

> This table contains the Visit Previous Med Dx Present Flag value returned from the third party interface.
...
| 5 | `VISIT_PREV_MED_DX_PRESENT_FLAG` | VARCHAR |  | The Visit Previous Med Dx Present Flag value returned from the third party interface. |

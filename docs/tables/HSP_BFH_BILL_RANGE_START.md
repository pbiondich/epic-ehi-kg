# HSP_BFH_BILL_RANGE_START

> Stores the billing start date for a billing activity.
...
| 4 | `ACT_BILL_START_DATE` | DATETIME |  | Holds the start date for a billing date range |

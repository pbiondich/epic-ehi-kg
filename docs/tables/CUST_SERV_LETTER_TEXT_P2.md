# CUST_SERV_LETTER_TEXT_P2

> This table contains part 2 of the contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_2` | VARCHAR |  | Contains plain text of part 2 of the document. |

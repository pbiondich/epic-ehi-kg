...
| 4 | `LN_AUTH_SOURCE_HSP_ACCOUNT_ID` | NUMERIC |  | The unique ID of the visit account when the authorization number on the row was found in the account. |

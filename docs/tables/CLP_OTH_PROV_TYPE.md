...
> This table stores the other provider type found on UB claims.
...
| 3 | `UB_OTHER_PROV_TYPE` | VARCHAR |  | This field is used to store the type of other provider on the uniform billing claim. |

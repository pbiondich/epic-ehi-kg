...
> This view contains audit information for guarantor account records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, AUDIT_ITM_ACCOUNT should be used instead.
...
|--:|--------|------|-------|-------------|
| 1 | `ACCOUNT_ID` | NUMERIC | PK FK→ | The ID of the account record that was changed. |
| 2 | `PAT_ID` | VARCHAR | FK→ | The ID of the patient associated with this account. |

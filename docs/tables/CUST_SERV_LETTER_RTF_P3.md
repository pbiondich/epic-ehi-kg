# CUST_SERV_LETTER_RTF_P3

> This table contains part 3 of the Rich Text Format (RTF) contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_RTF_3` | VARCHAR |  | Contains the Rich Text of part 3 of the document. |

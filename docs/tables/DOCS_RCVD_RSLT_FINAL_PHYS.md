# DOCS_RCVD_RSLT_FINAL_PHYS

> This table extracts the related multiple response Result Finalizing Physician (I DXR 5036) item.
...
| 6 | `RSLT_FINAL_PHYS` | VARCHAR |  | This item stores the finalizing physician of the result. |

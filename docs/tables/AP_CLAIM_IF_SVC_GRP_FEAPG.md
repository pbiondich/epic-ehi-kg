...
> This table contains the final Enhanced Ambulatory Patient Groups (EAPG) Code description returned from the third party interface.
...
| 5 | `FINAL_EAPG_DESC` | VARCHAR |  | The final EAPG Code description returned from the third party interface. |

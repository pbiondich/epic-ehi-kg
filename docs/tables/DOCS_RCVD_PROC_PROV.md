...
> This table stores the provider information for a procedure received from outside sources.
...
| 6 | `PROC_PROV_ID` | VARCHAR |  | This item stores the provider identifier stored in I DXR 9000 of an external data document. |

# AP_CLAIM_IF_SVC_GRP_MOD4

> This table contains edits returned from the third party interface for the fourth modifier.
...
| 5 | `MODIFIER_4_EDIT` | VARCHAR |  | The edits returned from the third party interface for the fourth modifier. |

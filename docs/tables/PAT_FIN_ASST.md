...
> Financial assistance items for the patient.
...
| 5 | `CHKIN_PAT_DEC_C_NAME` | NUMERIC |  | The decision the patient made when completing the Financial Assistance step in eCheck-In or Welcome. |

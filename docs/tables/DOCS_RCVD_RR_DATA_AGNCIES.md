# DOCS_RCVD_RR_DATA_AGNCIES

> This table extracts the related multiple response Responsible Agency (I DXR 49020) item.
...
| 6 | `RESPONSIBLE_AGENCY` | VARCHAR |  | The list of names of Public Health Authorities to which reporting is required. |

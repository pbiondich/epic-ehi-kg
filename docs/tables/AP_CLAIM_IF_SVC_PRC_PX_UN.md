# AP_CLAIM_IF_SVC_PRC_PX_UN

> This table contains the Procedure Unit Flag value returned from the third party interface.
...
| 5 | `PX_UNIT_FLAG` | VARCHAR |  | The Procedure Unit Flag value returned from the third party interface. |

# DOCS_RCVD_IND_CD_DISPNM

> This table stores the display names of all the mapping codes for one medication indication reference ID.
...
| 6 | `DISPLAY_NAME` | VARCHAR |  | The display names of all the mapping codes for one medication indication reference ID |

...
|--:|--------|------|-------|-------------|
| 1 | `NOTE_ID` | VARCHAR | PK shared | The internal unique ID of the note. |
...
| 4 | `ASC_PROC_ORDERS_ID` | NUMERIC |  | The unique ID of a linked procedure order for ambulatory procedure notes. |

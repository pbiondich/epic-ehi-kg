...
> This table contains a list of appointment request orders generated from each home health and hospice visit set.

**Primary key:** `CAREPLAN_ID`, `CONTACT_DATE_REAL`, `GROUP_LINE`, `VALUE_LINE`  
**Columns:** 6
...
| 6 | `VISIT_SET_APPT_REQ_ORDER_ID` | NUMERIC |  | The unique identifier of the appointment request order sent for each visit set. |

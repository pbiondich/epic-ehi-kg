...
> This table extracts the history of reasons associated with deselecting recommended child order items.
...
| 6 | `CHILD_REC_RSN_HX_C_NAME` | VARCHAR | org | Maintains the history of reasons for deselecting the recommended child order items |

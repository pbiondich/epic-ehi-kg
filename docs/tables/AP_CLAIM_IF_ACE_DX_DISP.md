...
| 4 | `HIGHEST_DX_DISP` | VARCHAR |  | The highest diagnosis disposition from Ambulatory Code Editor (ACE) output fields for ICD-9-CM diagnosis edits. |

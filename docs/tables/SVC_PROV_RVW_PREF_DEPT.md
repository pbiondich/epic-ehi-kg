# SVC_PROV_RVW_PREF_DEPT

> This table contains information about the department (DEP) records marked as preferred during the patient's review of lists of post-discharge service providers sent to them by their case manager.
...
| 6 | `REV_PREF_DEPARTMENT_ID_EXTERNAL_NAME` | VARCHAR |  | The external name of the department record. This is often used in patient correspondence such as reminder letters. |
| 7 | `REV_LIST_IDENT` | INTEGER |  | Stores the ID of the service provider list that has been reviewed. |

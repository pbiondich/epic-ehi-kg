...
| 3 | `IO_FLOWSHEETROW_IDS` | VARCHAR |  | Flowsheet rows that can be used for non-occurrence intake/output (IO) documentation. For duplicable rows, the identifier used to distinguish among multiple rows is stored in OCCURRENCE. |

# V_EHI_FLO_MEAS_EDITED

> This view converts the MEAS_VALUE column in IP_FLWSHT_EDITED into an external-facing format for EHI Export. This table should be used in tandem with IP_FLWSHT_EDITED, using the FSD_ID and LINE columns to join the two together.

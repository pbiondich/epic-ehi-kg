# DOCS_RCVD_OUTC_BNDL_KEYS

> This table extracts the related multiple response item DXR-74011.
...
| 6 | `EXT_CALC_OTCM_KEY` | INTEGER |  | Primary keys that each identify an individual outcome that was received for the specified contact. |

# PAT_ENC_RESRC_TYPE_EVAL

> This table contains resource type IDs for appt resources that are missing or no longer needed for an appt and therefore caused the order to return as modified but the modification has been dismissed by a scheduler.

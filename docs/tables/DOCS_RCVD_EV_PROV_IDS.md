# DOCS_RCVD_EV_PROV_IDS

> Contains external provider IDs used to link provider information to an event provider.
...
| 6 | `EV_PROV_REL_ID` | VARCHAR |  | Stores multiple provider IDs used to link to the Provider Information superitem (SI DXR 9000) and retrieve information about the provider (address, name, etc.) |

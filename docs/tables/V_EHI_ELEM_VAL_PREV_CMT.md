# V_EHI_ELEM_VAL_PREV_CMT

> This view contains the historical comments for SmartData element values.
...
| 4 | `PREV_COMMENT` | VARCHAR |  | This column stores the previous comments for SmartData element values. |

...
| 4 | `OTH_PYR_BP_SEC_QUAL` | VARCHAR |  | This item holds the qualifier for the billing provider secondary ID. It is used on both electronic and paper claims. |

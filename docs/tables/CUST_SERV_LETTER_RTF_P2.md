# CUST_SERV_LETTER_RTF_P2

> This table contains part 2 of the Rich Text Format (RTF) contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_RTF_2` | VARCHAR |  | Contains the Rich Text of part 2 of the document. |

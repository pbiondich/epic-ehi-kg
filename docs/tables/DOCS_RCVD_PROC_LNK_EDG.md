# DOCS_RCVD_PROC_LNK_EDG

> This table extracts the related multiple response External Procedure Linked Diagnosis (I DXR 17040) item.
...
| 6 | `PROC_LINKED_EDG_ID_DX_NAME` | VARCHAR |  | The name of the diagnosis. |

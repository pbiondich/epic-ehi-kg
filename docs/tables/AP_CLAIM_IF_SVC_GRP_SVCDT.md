# AP_CLAIM_IF_SVC_GRP_SVCDT

> This table contains Service Date Edits returned from the third party interface.
...
| 5 | `SERVICE_DATE_EDIT` | VARCHAR |  | The service Date Edits returned from the third party interface. |

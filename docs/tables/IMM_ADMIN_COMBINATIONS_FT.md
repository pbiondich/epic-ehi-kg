# IMM_ADMIN_COMBINATIONS_FT

> The IMM_ADMIN_COMBINATIONS_FT table contains free text immunization names which are part of the administered immunization each time. For example, Measles, Mumps and Rubella immunizations combined form the MMR immunization.
...
| 6 | `IMM_COMBO_FT` | VARCHAR |  | If the immunization is a combination, this field contains the free-text combination immunization information if there is no discrete information. |

# CUST_SERV_LETTER_RTF_P4

> This table contains part 4 of the Rich Text Format (RTF) contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_RTF_4` | VARCHAR |  | Contains the Rich Text of part 4 of the document. |

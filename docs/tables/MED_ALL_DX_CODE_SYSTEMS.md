# MED_ALL_DX_CODE_SYSTEMS

> This item stores the coding systems used for all diagnoses (for example, ICD-9) for incoming e-prescribing messages. This table is replacing columns PRIMARY_DX_CODE_SYSTEM and SECONDARY_DX_CODE_SYSTEM in table DOCS_RCVD_MEDS_2.

...
> This table extracts the related multiple response Imm Due - Reason Recommended (I DXR 4140) item.
...
| 6 | `IMM_DUE_REASON_C_NAME` | VARCHAR | org | Immunization due - Reason recommended |

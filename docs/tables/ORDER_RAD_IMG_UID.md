...
| 2 | `LINE` | INTEGER | PK | The line number for the number of image instance UIDs associated with an order. Multiple pieces of information can be associated with this. |
| 3 | `IMAGE_INSTANCE` | VARCHAR |  | The unique identifier of the DICOM image instance. |

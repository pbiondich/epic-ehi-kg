...
> This table holds providers attesting for Meaningful Use on Pre-Admission Testing (PAT) encounters.
...
| 6 | `AN_PAT_PROV_ID_PROV_NAME` | VARCHAR |  | The name of the service provider. This item may be hidden in a public view of the CLARITY_SER table. |

...
> This table stores the patient's phone information.
...
| 7 | `PHONE_NUMBER` | VARCHAR |  | The patient's phone number. |
| 8 | `DESCRIPTION` | VARCHAR |  | The patient phone number's description. |

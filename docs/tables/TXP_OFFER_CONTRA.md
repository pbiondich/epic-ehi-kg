...
> Contains recent contraindications that a patient had as a potential organ offer recipient.
...
| 7 | `TXP_OFFER_CONTRA_C_NAME` | VARCHAR | org | Recent contraindications that apply to a potential organ offer recipient. |

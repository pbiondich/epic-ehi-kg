# DOCS_RCVD_RSLT_SPEC_ID

> This table extracts the related multiple response Specimen ID (I DXR 5506) item.
...
| 6 | `SPEC_ID` | VARCHAR |  | Stores the ID generated by resulting labs to help identify a specimen |

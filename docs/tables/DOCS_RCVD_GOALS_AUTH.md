# DOCS_RCVD_GOALS_AUTH

> This table extracts the related multiple response Goal Author (I DXR 19005) item.
...
| 6 | `GOAL_AUTHOR` | VARCHAR |  | This item stores the name of the author that documented the goal. |

# DOCS_RCVD_MAMMO_HX_QUESNS

> This table contains information about the mammography history questions that were asked to a patient.
...
| 6 | `MAM_HX_HIST_FILE_ELEMENT_C_NAME` | VARCHAR |  | The questions asked to the patient in this questionnaire submission. |

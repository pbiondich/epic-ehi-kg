# HSP_BFH_BILL_RANGE_LOC

> Stores the level of care claim used when billing a range inside a billing activity.
...
| 4 | `ACT_BILL_LVL_OF_CARE_CLM_C_NAME` | VARCHAR |  | Holds the level of care for a billing date range |

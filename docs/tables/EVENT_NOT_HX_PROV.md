...
> This table extracts the Event Notification History - Sent to Provider related multiple response item.
...
| 5 | `SENT_TO_PROV_ID_PROV_NAME` | VARCHAR |  | The name of the service provider. This item may be hidden in a public view of the CLARITY_SER table. |

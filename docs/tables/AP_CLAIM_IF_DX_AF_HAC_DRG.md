...
| 4 | `DX_AFF_HAC_ADJ_DRG` | VARCHAR |  | How the diagnosis affected the diagnosis related group (DRG) assignment following hospital-acquired condition (HAC) adjusted DRG processing. |

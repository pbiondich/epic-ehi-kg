# AP_CLAIM_IF_SVC_GRP_VISPW

> This table contains the Visit Processed Warning value returned from the third party interface.
...
| 5 | `VISIT_PROCESSED_WARNING` | VARCHAR |  | The Visit Processed Warning value returned from the third party interface. |

...
> Table contains the Identity visit IDs.
...
| 6 | `MPI_CSID` | VARCHAR |  | To determine which patient owned which contact within a merged record |
| 7 | `MPI_CSID_TYPE_ID` | NUMERIC |  | To easily determine which contact owns which merged record |
| 8 | `MPI_CSID_TYPE_ID_ID_TYPE_NAME` | VARCHAR |  | The name of the ID Type. |

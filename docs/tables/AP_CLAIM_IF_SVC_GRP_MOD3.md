# AP_CLAIM_IF_SVC_GRP_MOD3

> This table contains edits returned from the third party interface for the third modifier.
...
| 5 | `MODIFIER_3_EDIT` | VARCHAR |  | The edits returned from the third party interface for the third modifier. |

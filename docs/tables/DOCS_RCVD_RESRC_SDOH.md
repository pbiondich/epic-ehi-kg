# DOCS_RCVD_RESRC_SDOH

> This table stores information about the social driver of health domains addressed by a particular community resource usage.
...
| 6 | `COM_RESRC_USAGE_SDOH_DOMAIN_C_NAME` | VARCHAR | org | This column stores the social driver of health domains that a community resource usage addresses. |

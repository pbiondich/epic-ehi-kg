...
> This table holds the outpatient remark codes from the other coverage's payment.
...
| 4 | `OTH_CVG_OP_REMK_CD` | VARCHAR |  | This item holds the outpatient remark codes from the other coverage's payment. |

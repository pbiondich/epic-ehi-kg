...
> This table contains the Pricing Status value returned from the third party interface.
...
| 5 | `PRICING_STATUS` | VARCHAR |  | The Pricing Status value returned from the third party interface. |

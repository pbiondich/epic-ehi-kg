...
> This table is an extracted related multi-item which lists all of the order templates for a given advanced order group.
...
| 6 | `ADV_GRP_ORD_OTL_ID_ORDER_DESC` | VARCHAR |  | Description of the procedure. |

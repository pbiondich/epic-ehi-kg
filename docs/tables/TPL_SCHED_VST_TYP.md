...
> This is the related-multi table for the 'Visit Type' item in the treatment plan scheduling group of tables. To be used with tables: TPL_SCHED_SELECTED TPL_SCHED_VST_DEP TPL_SCHED_VST_KND TPL_SCHED_VST_LEN TPL_SCHED_VST_PROV
...
| 4 | `SCHED_PRC_ID_PRC_NAME` | VARCHAR |  | The name of the visit type. |

...
| 4 | `LN_REPRICING_NOTE_TPO` | VARCHAR |  | The line level third party organization notes populated for Tapestry's generic external repricing interface. |

# BRACH_APPLICATOR_TYPE_TXT

> Contains the free text representation of the applicator type used in brachytherapy.
...
| 6 | `APPLICATOR_TYP_TEXT` | VARCHAR |  | Stores a free text representation of the applicator type used in brachytherapy. |

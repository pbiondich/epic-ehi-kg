# HSP_ACCT_EXPECTED_WRT_OFF

> The write-off amounts for pending financial assistance trackers linked to the hospital account.
...
|--:|--------|------|-------|-------------|
| 1 | `HSP_ACCT_ID` | NUMERIC | PK | The unique identifier (.1 item) for the account record. |
...
| 4 | `LAST_UPDATE_UTC_DTTM` | DATETIME (UTC) |  | Instant the write-off amounts were calculated for this financial assistance tracker. |

# IMM_ADMIN_REACTION_TYPE

> This IMM_ADMIN_REACTION_TYPE table contains the immunization administration reaction type for each performed administration.
...
| 6 | `IMM_REACTION_TYPE_C_NAME` | VARCHAR | org | The immunization administered adverse reaction category ID. |

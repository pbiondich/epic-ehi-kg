...
> This table contains Primary and Secondary case mix diagnoses information entered for a patient as part of a home health Outcome and Assessment Information Set (OASIS) assessment. The table stores values entered for M0246 for the Primary diagnosis for the contact.
...
| 6 | `CASE_MIX_DX_ID_DX_NAME` | VARCHAR |  | The name of the diagnosis. |
| 7 | `SEC_CASE_DX_ID_DX_NAME` | VARCHAR |  | The name of the diagnosis. |

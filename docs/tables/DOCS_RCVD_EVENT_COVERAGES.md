# DOCS_RCVD_EVENT_COVERAGES

> This table extracts the related multiple response Event Insurance Coverages (I DXR 8088) item.
...
| 6 | `EVENT_COVERAGES` | VARCHAR |  | Stores the reference IDs of insurance coverages that are applicable for this event. |

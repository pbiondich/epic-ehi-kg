# SPEC_TEST_CNCL_CTNRS

> Contains the performing containers for a test before it was canceled.
...
| 5 | `TEST_CNCLD_CONTAINER_ID` | VARCHAR |  | Specifies the performing containers which were associated with the test at the time it was canceled. |

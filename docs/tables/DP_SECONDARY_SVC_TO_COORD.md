# DP_SECONDARY_SVC_TO_COORD

> Table storing the specific services details for CCSC services to coordinate.
...
| 7 | `SEC_SVC_TO_COORD_GROUPER_ID_GROUPER_NAME` | VARCHAR |  | Record name |

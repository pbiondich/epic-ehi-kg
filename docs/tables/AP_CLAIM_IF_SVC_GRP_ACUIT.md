# AP_CLAIM_IF_SVC_GRP_ACUIT

> This table contains Acuity Indicator returned from the third party interface.
...
| 5 | `ACUITY_INDICATOR` | VARCHAR |  | Acuity Indicator returned from the third party interface. |

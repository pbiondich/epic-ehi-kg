# AP_CLAIM_IF_SVC_GRP_MOD3D

> This table contains edit descriptions returned from the third party interface for the third modifier.
...
| 5 | `MODIFIER_3_EDIT_DESC` | VARCHAR |  | The edit descriptions returned from the third party interface for the third modifier. |

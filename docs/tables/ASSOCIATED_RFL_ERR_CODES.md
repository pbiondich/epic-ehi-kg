# ASSOCIATED_RFL_ERR_CODES

> This table contains the list of errors for a referral when assignment to an appointment fails.
...
| 6 | `ASSOC_RFL_ERROR_CODE_C_NAME` | VARCHAR |  | Contains an error code which prevented the referral from being assigned to the visit. |

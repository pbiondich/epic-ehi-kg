# DOCS_RCVD_ASMT_QUES_CD_NM

> This table extracts the display names of codes linked to external assessment questions.
...
| 6 | `ASMNT_QUESTION_CODE_NAME` | VARCHAR |  | This item stores the display names of codes associated with assessment questions and their answers. |

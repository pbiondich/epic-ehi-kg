# ORD_NLP_INITIAL_LNK_RES

> This table contains information about links between findings and general recommendations that were extracted from radiology reports by a natural language processing model.

...
> The OR_LOG_PANEL_TIME2 table contains OR management system log panel timing information for the second panel.
...
| 11 | `INST_PNL2_INTER_UTC_DTTM` | DATETIME (UTC) |  | Instant of update for an event in panel 2. This will be used for Event Interval functionality. |

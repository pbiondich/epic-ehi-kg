...
> The benefit stage qualifier ID for an incoming D.0 adjudication.
...
| 5 | `I_BEN_STAGE_QUAL_ID` | NUMERIC |  | Specifies the benefit stage qualifier. |
| 6 | `I_BEN_STAGE_QUAL_ID_EXT_CODE_LST_NAME` | VARCHAR |  | The name of the list value. |

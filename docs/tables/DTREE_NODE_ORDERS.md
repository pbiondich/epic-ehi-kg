...
| 4 | `CREATED_ORDER_ID` | NUMERIC |  | For a given action node, stores the orders that were created (either pended or signed) as a by-product of the user taking this action. |

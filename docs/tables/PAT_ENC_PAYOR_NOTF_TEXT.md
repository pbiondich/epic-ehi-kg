# PAT_ENC_PAYOR_NOTF_TEXT

> This table extracts the free text + displayed status text (derived from AAA codes) message lines associated with a single payor notification.
...
| 7 | `NOTIF_MSG_FREE_TXT` | VARCHAR |  | One line of text content from the payer notification message free text / displayed status text. |

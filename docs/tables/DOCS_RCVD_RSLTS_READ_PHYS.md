# DOCS_RCVD_RSLTS_READ_PHYS

> This table extracts the related multiple response Result Read Physician (I DXR 5038) item.
...
| 6 | `RSLT_READ_PHYS` | VARCHAR |  | This item stores the reading physician of the result. |

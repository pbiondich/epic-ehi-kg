...
> This table stores communications that are, or previously were, waiting for results before being sent.
...
| 5 | `COMM_JOB_ID` | VARCHAR |  | The job ID of the communications that are waiting for results. |

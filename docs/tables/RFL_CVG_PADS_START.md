...
> Related multi table for the Auth-Cert Avoidable Days Start Date (I RFL 8507) item.
...
| 4 | `PADS_START_DATE` | DATETIME |  | Coverage Level Possible Avoidable Days (PADS) Start Date |

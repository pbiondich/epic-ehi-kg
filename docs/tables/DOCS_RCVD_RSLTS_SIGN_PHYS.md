# DOCS_RCVD_RSLTS_SIGN_PHYS

> This table extracts the related multiple response Result Signed Physician (I DXR 5034) item.
...
| 6 | `RSLT_SIGNED_PHYS` | VARCHAR |  | This item stores the signed physician of the result. |

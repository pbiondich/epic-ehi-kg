# AP_CLAIM_IF_SVC_GRP_MOD1D

> This table contains edit descriptions returned from the third party interface for the first modifier.
...
| 5 | `MODIFIER_1_EDIT_DESC` | VARCHAR |  | The edit descriptions returned from the third party interface for the first modifier. |

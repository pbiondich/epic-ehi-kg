...
> This table stores the the current Visit Hub Widget state category value for the associated Widget Hash and was last updated at the associated update instant.
...
| 7 | `WIDGET_STATUS_C_NAME` | VARCHAR |  | The various statuses associated with Visit Hub widgets. |

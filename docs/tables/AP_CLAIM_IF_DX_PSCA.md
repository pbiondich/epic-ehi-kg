...
| 4 | `PSCA` | VARCHAR |  | The PSCA (Proportional Standard Cost Allocation) assigned to this diagnosis code taking into consideration the age and gender of the patient. |

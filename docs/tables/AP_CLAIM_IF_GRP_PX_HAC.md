# AP_CLAIM_IF_GRP_PX_HAC

> This table contains the Description of the procedure used for hospital-acquired condition (HAC) processing returned from the third party interface.
...
| 5 | `PX_HAC_PROCESSING_DESC` | VARCHAR |  | Description of the procedure used for HAC processing. |

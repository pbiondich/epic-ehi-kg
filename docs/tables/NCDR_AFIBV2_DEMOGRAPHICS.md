# NCDR_AFIBV2_DEMOGRAPHICS

> This table contains information from the Demographics section of the NCDR AFib Ablation registry v2.0.
...
| 3 | `CURRENT_UNOS_STAGE_C_NAME` | VARCHAR | org | The current state of the registry record |

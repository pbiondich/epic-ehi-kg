...
> Guarantor statuses removed during the billing activity.
...
| 4 | `ACTION_EARSTS_RM_C_NAME` | VARCHAR | org | The guarantor statuses that were removed by the associated action. |

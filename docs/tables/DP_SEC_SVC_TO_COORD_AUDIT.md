# DP_SEC_SVC_TO_COORD_AUDIT

> This table contains the secondary sevice data for the audit trail of the Services to Coordinate workflow.
...
| 7 | `SECONDARY_SVC_AUDIT_GROUPER_ID_GROUPER_NAME` | VARCHAR |  | Record name |

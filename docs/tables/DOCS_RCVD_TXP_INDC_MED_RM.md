# DOCS_RCVD_TXP_INDC_MED_RM

> This table extracts the related multiple response item DXR-13105.
...
| 6 | `TXP_SURG_MEDS_C_NAME` | VARCHAR | org | List of induction medications used during surgery. |

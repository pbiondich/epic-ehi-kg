# LCI_HEDIS_PLAN_PROD_LINES

> Clarity table for the HEDIS plan product lines related multiple item in LCI.
...
| 5 | `HEDIS_PRD_LINES_C_NAME` | VARCHAR |  | The NCQA HEDIS plan product lines of an external coverage contact. |

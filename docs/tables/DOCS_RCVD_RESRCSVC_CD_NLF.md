# DOCS_RCVD_RESRCSVC_CD_NLF

> This table stores the nullflavors for the codes compiled for a particular service recommended at a community resource.
...
| 6 | `COMM_RESRC_SVC_NULLFLAVOR_C_NAME` | VARCHAR |  | Stores the code nullflavors for a community resource service recommended. |

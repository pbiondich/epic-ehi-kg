...
> For each treatment plan order from an advanced order group in a treatment day of a treatment plan, this table specifies whether the order was selected and added to the plan.

# DOCS_RCVD_ASMT_QUES_CD_NF

> This table extracts the nullflavors linked to external assessment questions.
...
| 6 | `ASMNT_QUESTION_NULLFLAVOR_C_NAME` | VARCHAR |  | This item stores the null flavors for assessment questions and their answers. |

...
|--:|--------|------|-------|-------------|
| 1 | `ORDER_MED_ID` | NUMERIC | PK FK→ | The unique orders record ID for the medication order. |
...
| 26 | `SIG_REQ_CRT_SRC_C_NAME` | VARCHAR |  | This item stores the creation source for order signature requirements. |

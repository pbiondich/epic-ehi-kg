...
> This table extracts the related multiple response item ERT-312.
...
| 5 | `REASON_DISPLAY_NAME` | VARCHAR |  | Stores the display name for the code in ERT 310 indicating why radiation therapy was prescribed or used. |

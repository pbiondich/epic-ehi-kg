# DOCS_RCVD_ENDO_FND_SDEVAL

> This table stores the SDE values of the suggested endoscopy findings received from outside sources.
...
| 6 | `SUGG_FND_DATA_VALUE` | VARCHAR |  | The value that is being suggested for this finding/SDE combination |

# DOCS_RCVD_TREAT_VERIF_DT

> This table contains information about when treatment restrictions have been verified.
...
| 6 | `TRT_RESTR_VERIF_DATE` | DATETIME |  | The date when the treatment restriction was verified |

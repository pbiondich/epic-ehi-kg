# AP_CLAIM_IF_GRP_RFV_DXUSD

> This table contains the reason for visit (RFV) diagnosis used description value returned from the third party interface.
...
| 5 | `RFV_DX_USED_DESCRIPTION` | VARCHAR |  | The RFV Diagnosis Used Description value returned from the third party interface. |

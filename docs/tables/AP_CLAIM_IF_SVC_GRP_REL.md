# AP_CLAIM_IF_SVC_GRP_REL

> This table contains the Relationship Edit value returned from the third party interface.
...
| 5 | `RELATIONSHIP_EDIT` | VARCHAR |  | The Relationship Edit value returned from the third party interface. |

...
> This table extracts the related multiple response Refill Criteria (I ALT 2025) item. It records the refill protocol criteria evaluated when a refill protocol is triggered.
...
| 6 | `BPA_REFILL_CRIT_ID_LOCATOR_NAME` | VARCHAR |  | The name of the Locator record. |

# DOCS_RCVD_OBJ_RSLT_IDENT

> Table for related multiple response Object Linked Result Identifier (I DXR 6085) item, a list of reference IDs associated with the document.
...
| 6 | `OBJ_LNK_RESULT_IDENT` | VARCHAR |  | The result identifiers of the object that this object is associated to. |

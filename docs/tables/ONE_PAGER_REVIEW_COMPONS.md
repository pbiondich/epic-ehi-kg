# ONE_PAGER_REVIEW_COMPONS

> This table extracts the related multiple response item EPT-89103.
...
| 7 | `AT_A_GLANCE_COMPONENTS_C_NAME` | VARCHAR |  | This item holds the list of components that were available in the At a Glance section when it was marked as reviewed. |

# DOCS_RCVD_TREAT_RESTR_NF

> This table contains nullflavors of all the codes for treatment restrictions.
...
| 6 | `TREAT_RESTR_NF_C_NAME` | VARCHAR |  | The nullflavors of all the codes for a treatment restriction reference ID |

# CUST_SERV_LETTER_DOC_PART

> This table contains the information about the parts of Customer Relationship Management letters.
...
| 6 | `DOC_PART_CAPTION` | VARCHAR |  | Contains the captions for the parts of multi-part documents. |
| 7 | `LETTER_NUM_PARTS` | INTEGER |  | Holds number of parts in the document (max 5 parts). |

# AP_CLAIM_IF_SVC_GRP_REL_D

> This table contains Relationship Edit Description value returned from the third party interface.
...
| 5 | `RELATIONSHIP_EDIT_DESC` | VARCHAR |  | The Relationship Edit Description value returned from the third party interface. |

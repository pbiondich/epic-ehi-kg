# AP_CLAIM_IF_SVC_GRP_MOD5D

> This table contains edit descriptions returned from the third party interface for the fifth modifier.
...
| 5 | `MODIFIER_5_EDIT_DESC` | VARCHAR |  | The edit descriptions returned from the third party interface for the fifth modifier. |

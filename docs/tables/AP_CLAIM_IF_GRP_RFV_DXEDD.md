# AP_CLAIM_IF_GRP_RFV_DXEDD

> This table contains the reason for visit (RFV) diagnosis edit description value returned from the third party interface.
...
| 5 | `RFV_DX_EDIT_DESCRIPTION` | VARCHAR |  | The RFV Diagnosis Edit Description value returned from the third party interface. |

# AP_CLAIM_IF_SVC_GRP_MOD5

> This table contains edits returned from the third party interface for the fifth modifier.
...
| 5 | `MODIFIER_5_EDIT` | VARCHAR |  | The edits returned from the third party interface for the fifth modifier. |

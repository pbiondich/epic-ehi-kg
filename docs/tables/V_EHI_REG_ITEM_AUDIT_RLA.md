# V_EHI_REG_ITEM_AUDIT_RLA

> Patient relationship audit events. This view contains audit information for patient relationship records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, REG_ITEM_AUDIT_RLA and REG_ITEM_AUDIT_LINES_RLA should be used instead.
...
| 5 | `PAT_RELATIONSHIP_ID` | NUMERIC | FK→ | Patient relationship that was changed in this audit event. |

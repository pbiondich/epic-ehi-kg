...
> This table stores HLA-B genotype information for a platelet product.
...
| 4 | `HLAB_ALLELE_C_NAME` | VARCHAR |  | Stores HLA-B genotype information for a platelet product. |

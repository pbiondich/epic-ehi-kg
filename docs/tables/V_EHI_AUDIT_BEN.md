...
> This view contains audit information for benefit records for the purpose of Electronic Health Information (EHI) export. If not in the EHI context, AUDIT_ITM_BENEFIT should be used instead.

**Primary key:** `BENEFIT_ID`, `CHANGE_TIME`, `CHANGED_DATA_ELEMENT`, `LINE`  
**Columns:** 11
...
|--:|--------|------|-------|-------------|
| 1 | `BENEFIT_ID` | NUMERIC | PK | The ID of the benefits record that was changed. |
| 2 | `PAT_ID` | VARCHAR | FK→ | The ID of the patient associated with this benefit record. |

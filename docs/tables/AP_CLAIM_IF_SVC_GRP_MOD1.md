# AP_CLAIM_IF_SVC_GRP_MOD1

> This table contains edits returned from the third party interface for the first modifier.
...
| 5 | `MODIFIER_1_EDIT` | VARCHAR |  | The edits returned from the third party interface for the first modifier. |

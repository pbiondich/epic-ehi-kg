# RADIOTHERAPY_TECHNIQ_TEXT

> This table contains the free text descriptions to be used in place of codes from ERT 610-Technique Codes if no codes are present.
...
| 5 | `TECHNIQUE_TEXT` | VARCHAR |  | This item stores the text element for the technique that is to be used when the technique code item (ERT 610) does not contain a coded concept |

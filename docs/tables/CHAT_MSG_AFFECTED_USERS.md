# CHAT_MSG_AFFECTED_USERS

> This table extracts the affected users for a chat message.
...
| 5 | `AFFECTED_USER_ID` | VARCHAR |  | Holds user IDs added or removed by the event a message references |
| 6 | `AFFECTED_USER_ID_NAME` | VARCHAR |  | The name of the user record. This name may be hidden. |

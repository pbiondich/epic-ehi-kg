# AP_CLAIM_IF_SVC_GRP_MODJW

> This table contains the Modifier JW Present Flag value returned from the third party interface.
...
| 5 | `MODIFIER_JW_PRESENT_FLAG` | VARCHAR |  | The Modifier JW Present Flag value returned from the third party interface. |

# DOCS_RCVD_TRT_VERIF_WITH

> This table contains information about whom treatment restrictions have been verified with.
...
| 6 | `TREAT_VERIF_WITH_C_NAME` | VARCHAR | org | The treatment restrictions verified with category ID for the received document. |

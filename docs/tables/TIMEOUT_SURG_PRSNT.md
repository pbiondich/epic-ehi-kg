...
> This table stores the surgeons who were present during timeout.
...
| 6 | `STAFF_PRES_SURG_ID_PROV_NAME` | VARCHAR |  | The name of the service provider. This item may be hidden in a public view of the CLARITY_SER table. |

# CANCER_RISK_REQ_STATUS

> This table contains the statuses of risk models for patients whose scores were user requested.
...
| 4 | `SCORE_REQ_MODEL_STATUS_C_NAME` | VARCHAR |  | This column stores the status of the request for a model's cancer risk scores. |

...
> Indications of use Clarity table.
...
| 2 | `LINE` | INTEGER | PK | Line number for indication(s) of use saved in multiple response items. |
| 3 | `INDICATIONS_ID` | NUMERIC |  | Stores the selected Indication(s) of Use for an Order Template. |

...
| 2 | `REGISTRY_DATA_ID` | NUMERIC | shared | The unique ID of the linked registry data record that is associated with the SmartData element value. |

# VISIT_PREDICTIONS_DTS

> This table contains the related multiple response item Expected Dates (I EPT 10933). One date is listed for every date a prediction spans.
...
| 7 | `EXPECTED_DATE` | DATETIME |  | The dates the patient is expected in this location. |

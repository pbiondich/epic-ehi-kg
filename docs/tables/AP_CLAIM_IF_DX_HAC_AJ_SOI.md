...
| 4 | `DX_HAC_ADJ_SOI` | VARCHAR |  | Diagnosis severity of illness assignment at discharge following Hospital-Acquired condition adjusted processing. |

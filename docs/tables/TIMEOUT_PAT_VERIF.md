...
> The TIMEOUT_PAT_VERIF table stores the answer for the "Patient verification methods?" question for a timeout.
...
| 5 | `PAT_VERIF_METHODS_C_NAME` | VARCHAR | org | The Patient Verification Methods category number for a timeout. |

...
> Table extracts the manually linked case/log information that can be tied to an ADT encounter.
...
| 5 | `EXTERNAL_CASE` | VARCHAR |  | The case IDs associated with this contact in an external surgical system. |

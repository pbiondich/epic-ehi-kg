...
| 4 | `OUT_ICDPX_DATE` | VARCHAR |  | The date of the ICD Procedure on the claim being sent out to the Ambulatory Payment Classification (APC) interface. |

...
| 4 | `LN_ADJ_BUND_LN_NUM` | INTEGER |  | This item holds the line number into which the service was bundled when the payer bundled the service lines. |

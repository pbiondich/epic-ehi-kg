# AP_CLAIM_PROGRAM_INFO

> This table contains information about the program that a medical claim is associated with.
...
| 3 | `PROGRAM_ID` | NUMERIC | FK→ | This item contains the external ID of a Value Based Program (VBP) record or records representing the programs that the claim is associated with. |

# FIN_ASST_CASE_EXP_DOCS

> Table of documents linked to an expense on a financial assistance case.
...
| 4 | `DOCUMENT_ID` | VARCHAR | shared | Documents associated with an expense. |

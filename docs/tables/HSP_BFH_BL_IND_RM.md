...
> Billing indicators removed during the billing activity.
...
| 4 | `ACTION_BILL_RMVD_C_NAME` | VARCHAR | org | The category numbers of the billing indicators that were removed by the associated action. |

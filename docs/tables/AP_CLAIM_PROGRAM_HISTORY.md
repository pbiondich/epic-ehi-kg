# AP_CLAIM_PROGRAM_HISTORY

> This table tracks the history of changes to the Value Based Programs associated with medical claims.
...
| 7 | `UPDATE_INSTANT_UTC_DTTM` | DATETIME (UTC) |  | The Coordinated Universal Time (UTC) instant when the Value Based Program was modified. |

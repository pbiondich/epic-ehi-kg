...
| 4 | `DX_EXT_REF_IDENT` | VARCHAR |  | The external data reference identifier associated with the diagnosis identified by the medication therapy opportunities engine evaluation. |

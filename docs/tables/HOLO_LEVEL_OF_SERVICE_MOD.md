...
| 4 | `LEVEL_OF_SERVICE_MODIFIER_ID` | VARCHAR |  | The unique identifier (.1 item) of the modifier for the level of service in this hologram record. |
| 5 | `LEVEL_OF_SERVICE_MODIFIER_ID_MODIFIER_NAME` | VARCHAR |  | The name of the modifier record. |

...
> This table extracts the related multiple response item Dose at Action - Ingredient Discrete Dose (I OTP 8021).
...
| 4 | `DOSE` | VARCHAR |  | The ingredient discrete dose at the action. |

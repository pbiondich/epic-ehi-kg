...
| 4 | `DX_AFF_HAC_ADJ_SOI` | VARCHAR |  | How the diagnosis affected the Hospital Acquired Condition (HAC)-adjusted severity of illness (SOI) assignment. |

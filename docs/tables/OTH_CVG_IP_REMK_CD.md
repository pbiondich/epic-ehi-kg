...
> This table holds the inpatient remark codes from the other coverage's payment.
...
| 4 | `OTH_CVG_IP_REMK_CD` | VARCHAR |  | This item holds the inpatient remark codes from the other coverage's payment. |

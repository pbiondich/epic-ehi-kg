# DOCS_RCVD_BLLDX_CD_NLFLVR

> This table stores the nullFlavor values of all the mapping codes for one billing diagnosis reference ID.
...
| 6 | `CODE_NULLFLAVOR_C_NAME` | VARCHAR |  | The nullFlavor values of all the mapping codes for one billing diagnosis reference ID |

# AP_CLAIM_IF_SVC_GRP_REVED

> This table contains the Revenue Code Edit Description value returned from the third party interface.
...
| 5 | `REVENUE_CODE_EDIT_DESC` | VARCHAR |  | The Revenue Code Edit Description value returned from the third party interface. |

# DOCS_RCVD_RSLTS_REGION

> This table extracts the related multiple response Result Anatomical Region (I DXR 5056) item.
...
| 6 | `RSLT_ANATOM_REGION` | VARCHAR |  | This item stores the anatomical region for the result. |

...
> Contains embryology tags for a specimen.
...
| 4 | `EMB_SPEC_TAGS_C_NAME` | VARCHAR |  | Holds Embryology tags that are related to the specimen. |
| 5 | `EMB_SPEC_TAGS_C_CMT` | VARCHAR |  | A free-text comment related to one of a specimen's tags. |

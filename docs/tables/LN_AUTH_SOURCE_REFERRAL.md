...
| 4 | `LN_AUTH_SOURCE_REFERRAL_ID` | NUMERIC |  | The unique ID of the referral or auth/cert record when the authorization number on the row was found in the referral or auth/cert. |

...
> The table that stores the codes for rejection of a claim.
...
| 5 | `I_REJECT_CODE_ID` | NUMERIC |  | NCPDP code indicating the error encountered. |
| 6 | `I_REJECT_CODE_ID_EXT_CODE_LST_NAME` | VARCHAR |  | The name of the list value. |

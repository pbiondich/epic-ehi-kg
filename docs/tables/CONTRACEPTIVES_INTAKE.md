# CONTRACEPTIVES_INTAKE

> Contraceptives reported by the patient as being in active use as of the start of the encounter.
...
| 6 | `SEX_QUESN_BTHCR_C_NAME` | VARCHAR | org | Contraceptive reported by the patient as being in active use as of the start of the encounter. |

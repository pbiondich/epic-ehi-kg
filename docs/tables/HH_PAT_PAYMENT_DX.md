...
| 3 | `PAYMENT_DX_ID_DX_NAME` | VARCHAR |  | The name of the diagnosis. |
| 4 | `PAYMENT_DX_DATE` | DATETIME |  | Payment diagnosis date. |
| 5 | `PAYMNT_DX_SEVERITY` | INTEGER |  | Payment diagnosis severity, 0-4. |

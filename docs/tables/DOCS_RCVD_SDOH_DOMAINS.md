# DOCS_RCVD_SDOH_DOMAINS

> This table extracts the domains linked to an external social driver of health entry.
...
| 6 | `SDOH_DOMAIN_C_NAME` | VARCHAR | org | This item stores the domains a social driver entry is included in. |

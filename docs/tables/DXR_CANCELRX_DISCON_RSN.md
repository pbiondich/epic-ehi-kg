# DXR_CANCELRX_DISCON_RSN

> Discontinue reasons corresponding to cancel reason codes received in CancelRx messages.
...
| 6 | `RX_RSN_FOR_DISCON_C_NAME` | VARCHAR | org | Discontinue reasons corresponding to cancel reason codes received in CancelRx messages. |

# CUST_SERV_LETTER_RTF_P5

> This table contains part 5 of the Rich Text Format (RTF) contents of Customer Relationship Management letters.
...
| 6 | `LETTER_TEXT_RTF_5` | VARCHAR |  | Contains the Rich Text of part 5 of the document. |

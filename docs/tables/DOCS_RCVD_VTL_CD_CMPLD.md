# DOCS_RCVD_VTL_CD_CMPLD

> This table stores the data type, coding system, and code data received for a vital reference ID.
...
| 6 | `DATA_TYPE_C` | INTEGER |  | The data type associated with the code and coding system. |
| 7 | `CODING_SYSTEM` | VARCHAR |  | The mapping coding system associated with the code to represent the data. |
| 8 | `CODE` | VARCHAR |  | The mapping code associated with the coding system to represent the data. |

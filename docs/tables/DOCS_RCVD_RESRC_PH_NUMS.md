# DOCS_RCVD_RESRC_PH_NUMS

> This table stores the phone numbers of a particular community resource usage.
...
| 6 | `COMMUNITY_RESRC_PHONE_NUM` | VARCHAR |  | This column stores the phone number(s) of the community resource being used. |

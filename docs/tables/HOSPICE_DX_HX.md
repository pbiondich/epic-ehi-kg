...
| 4 | `ENTRY_USER_ID` | VARCHAR |  | The ID of the user who entered the hospice diagnosis. |
| 5 | `ENTRY_UTC_DTTM` | DATETIME (UTC) |  | This column stores the instant at which the hospice diagnosis was entered. |

# ORD_NLP_VERIF_LUNG_ASMT

> This table contains information about lung screening assessments that were present on orders when the output from a natural language processing model to extract lung screening assesments was verified or last modified.

# AP_CLAIM_IF_GRP_RFV_DXUSE

> This table contains the reason for visit (RFV) diagnosis used value returned from the third party interface.
...
| 5 | `RFV_DX_USED` | VARCHAR |  | The RFV Diagnosis Used value returned from the third party interface. |

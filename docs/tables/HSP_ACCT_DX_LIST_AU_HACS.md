...
| 4 | `DX_AU_HAC_CAT_C_NAME` | VARCHAR |  | This item stores the Australian hospital acquired complication category associated with each coded diagnosis. |

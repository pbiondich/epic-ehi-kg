# DOCS_RCVD_RSLTS_PERFORMBL

> This table extracts the names of procedures that were performed to get result information at outside sources.
...
| 5 | `RESULT_PERFORMABLE_NAME` | VARCHAR |  | Names of the procedures that were performed to get result information. |

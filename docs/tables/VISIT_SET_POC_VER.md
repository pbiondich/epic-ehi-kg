...
> Data related to the plan of care records containing a particular visit set version.
...
| 5 | `POC_CSN_ID` | NUMERIC |  | The linked Plan of Care (POC) versions this visit set version is on |

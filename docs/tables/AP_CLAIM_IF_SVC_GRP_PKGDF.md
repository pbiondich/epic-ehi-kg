# AP_CLAIM_IF_SVC_GRP_PKGDF

> This table contains the Packaged Per Diem Flag value returned from the third party interface.
...
| 5 | `PACKAGED_PER_DIEM_FLAG` | VARCHAR |  | The Packaged Per Diem Flag value returned from the third party interface. |

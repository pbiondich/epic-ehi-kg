...
> This table contains the history of unformatted prescription numbers for each component in an Intelligent Medication Selection (IMS) tab mixture in Long Term Care (including the current active unformatted prescription number).

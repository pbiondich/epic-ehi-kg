# DOCS_RCVD_SDOH_CD_DISPNMS

> This table extracts the display names of codes linked to external social driver of health entries.
...
| 6 | `SDOH_CODE_DISPLAY_NAME` | VARCHAR |  | This item stores the display names of codes associated with a social driver entry. |

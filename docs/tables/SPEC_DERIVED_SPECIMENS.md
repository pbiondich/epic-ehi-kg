# SPEC_DERIVED_SPECIMENS

> The SPEC_DERIVED_SPECIMENS table contains information related to the source specimen and other details relevant to the derived specimen. One line represents one source specimen of this derived specimen.

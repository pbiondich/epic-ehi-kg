# SLR_REVIEW_COMMENT_TEXT

> This table stores review comment text data from second-level reviews.
...
| 3 | `REVIEW_COMMENT_TEXT` | VARCHAR |  | The overall review comments entered by the reviewer. |

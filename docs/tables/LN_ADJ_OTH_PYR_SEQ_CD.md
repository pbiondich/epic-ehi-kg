...
| 4 | `LN_ADJ_OTH_PYR_SEQ_CD` | VARCHAR |  | This column stores the sequence code identifying the filing order for the other coverage payer at the service line level. |

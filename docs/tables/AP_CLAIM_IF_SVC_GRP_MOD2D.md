# AP_CLAIM_IF_SVC_GRP_MOD2D

> This table contains edit descriptions returned from the third party interface for the second modifier.
...
| 5 | `MODIFIER_2_EDIT_DESC` | VARCHAR |  | The edit descriptions returned from the third party interface for the second modifier. |

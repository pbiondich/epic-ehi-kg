...
> Stores the answer for the "Site marked with?" question for a timeout.
...
| 5 | `SITE_MARK_WITH_C_NAME` | VARCHAR | org | The Site Marked With category number for a timeout. |

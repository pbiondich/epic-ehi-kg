# ENC_METRIC_ENGINE_SRC

> The sources used to collect the data used to calculate these metrics, such as the name of a patient-worn device.
...
| 7 | `METRICS_DATA_SRCS` | VARCHAR |  | The sources used to collect this data, such as the name of a patient-worn device. If multiple sources are specified, they will display as a comma-delimited list. |

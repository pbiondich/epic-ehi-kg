...
> This table contains a list of orders that the provider signed off on when the provider performed the verification.
...
| 6 | `VERIF_ORDERS_ID` | NUMERIC |  | The orders related to this provider's verification. |

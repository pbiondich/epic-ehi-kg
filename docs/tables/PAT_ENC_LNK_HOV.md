...
> This table extracts the list of encounters linked together when using the Linked Hospital Outpatient Visit (HOV) functionality.
...
| 5 | `LINKED_CSN` | NUMERIC |  | The list of unique contact serial numbers of encounters that are linked to this HOV. |

...
| 5 | `O_DX_CODE_QUAL_ID` | NUMERIC |  | The code that qualifies the 'Diagnosis Code' (424-DO) |
| 6 | `O_DX_CODE_QUAL_ID_EXT_CODE_LST_NAME` | VARCHAR |  | The name of the list value. |
| 7 | `O_DX_CODE` | VARCHAR |  | The code that identifies the diagnosis of the patient. |

...
> The OR_CASE_ADTL_RES table contains OR management system case additional resource requests.
...
| 2 | `LINE` | INTEGER | PK | The number of the line of the additional resource within the case. |

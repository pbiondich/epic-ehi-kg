# AP_CLAIM_IF_SVC_GRP_PXEDD

> This table contains the Procedure Edit Description value returned from the third party interface.
...
| 5 | `PX_EDIT_DESCRIPTION` | VARCHAR |  | The Procedure Edit Description value returned from the third party interface. |

...
> Table tracks the interpretation generated from spirometry tests.
...
| 6 | `SPIRO_INTER` | VARCHAR |  | Stores the automatic interpretation made by the spirometry software based on predicted and actual test results. |

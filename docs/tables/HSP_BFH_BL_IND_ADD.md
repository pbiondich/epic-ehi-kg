...
> Billing indicators added during the billing activity.
...
| 4 | `ACTION_BILLIN_ADD_C_NAME` | VARCHAR | org | The category numbers of the billing indicators that were added by the associated action. |

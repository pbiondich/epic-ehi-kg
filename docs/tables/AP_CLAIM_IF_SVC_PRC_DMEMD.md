...
> This table contains the service line DME Modifier Present Flag returned from the third party interface.
...
| 5 | `DME_MODIFIER_PRESENT_FLAG` | VARCHAR |  | The service line DME Modifier Present Flag returned from the third party interface. |

# DOCS_RCVD_NOTES_PROC_LNK

> Contains IDs for orders associated with notes.
...
| 6 | `NOTE_ASSOC_PROC_ID` | VARCHAR |  | The reference IDs of the procedures that a clinical note is associated with. |

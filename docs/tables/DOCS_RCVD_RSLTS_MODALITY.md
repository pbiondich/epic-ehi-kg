# DOCS_RCVD_RSLTS_MODALITY

> This table extracts the related multiple response Result Modality Type (I DXR 5054) item.
...
| 6 | `RSLT_MODALITY_TYPE` | VARCHAR |  | This item stores the modality type for the result. |

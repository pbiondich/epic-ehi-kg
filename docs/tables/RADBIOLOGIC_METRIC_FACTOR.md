...
> Factor or ratio for a radiobioloigcal metric.
...
| 6 | `RADBIO_METRIC_FACTOR_OR_RATIO` | NUMERIC |  | Stores factor or alpha/beta value used in radiobiologic metrics defined by TG-263. |

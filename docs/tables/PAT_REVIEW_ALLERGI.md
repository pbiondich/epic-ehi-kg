...
| 6 | `PAT_REVIEW_ELG_ID` | NUMERIC |  | Patient allergies reviewed by patient. |
| 7 | `PAT_REVIEW_ELG_ID_ALLERGEN_NAME` | VARCHAR |  | The name of the allergen record. |
| 8 | `PAT_REVIEW_ELG_R_YN` | VARCHAR |  | Patient allergies reviewed by patient response. |
| 9 | `PAT_REVIEW_EXTERNAL` | VARCHAR |  | Patient allergies reviewed by the patient, entered in a free text format. |

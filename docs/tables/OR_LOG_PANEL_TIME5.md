...
> The OR_LOG_PANEL_TIME5 table contains OR management system log panel timing information for the fifth panel.
...
| 11 | `INST_PNL5_INTER_UTC_DTTM` | DATETIME (UTC) |  | Instant of update for an event in panel 5. This will be used for Event Interval functionality. |

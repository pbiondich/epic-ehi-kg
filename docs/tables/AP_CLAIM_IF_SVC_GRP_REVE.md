# AP_CLAIM_IF_SVC_GRP_REVE

> This table contains the Revenue Code Edit value returned from the third party interface.
...
| 5 | `REVENUE_CODE_EDIT` | VARCHAR |  | The Revenue Code Edit value returned from the third party interface. |

# DP_COMM_ORIG_LINE_RM

> This table extracts the related multiple response DP Facility - Original Sending Line Num (I EPT 34024) item.
...
| 6 | `ORIG_SEND_VAL_LN` | INTEGER |  | If this line documents a resent communication, this column includes the VALUE_LINE number (in this table) of the line documenting the original sending of that report. This column is NULL on lines documenting an original sending. |

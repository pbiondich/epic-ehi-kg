...
> This table extracts the related multiple response item ERT-310.
...
| 5 | `REASON_CODE` | VARCHAR |  | Stores the reason code indicating why radiation therapy was prescribed or used. |

...
| 3 | `MESSAGE_ID` | VARCHAR | FK→ | This is the list of messages for this MyChart conversation |
| 4 | `SENT_UTC_DTTM` | DATETIME (UTC) |  | This is when the corresponding MyChart message was sent |

...
> This table specifies the order category for each treatment plan order from an advanced order group in a treatment day of a treatment plan.
...
| 6 | `ADV_GRP_ORD_CAT_C_NAME` | VARCHAR | org | This column specifies the order category for each treatment plan order from an advanced order group in a treatment day of a treatment plan. |

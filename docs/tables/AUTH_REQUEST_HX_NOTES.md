# AUTH_REQUEST_HX_NOTES

> This table contains the notes associated with the authorization request.
...
| 4 | `NOTE_ID` | VARCHAR | shared | The unique ID of the note associated with the authorization request. |

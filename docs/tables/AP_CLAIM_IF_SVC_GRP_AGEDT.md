# AP_CLAIM_IF_SVC_GRP_AGEDT

> This table contains Agency Edit value returned from the third party interface.
...
| 5 | `AGENCY_EDIT` | VARCHAR |  | The Agency Edit value returned from the third party interface. |

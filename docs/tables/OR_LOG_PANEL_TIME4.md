...
> The OR_LOG_PANEL_TIME4 table contains OR management system log panel timing information for the fourth panel.
...
| 11 | `INST_PNL4_INTER_UTC_DTTM` | DATETIME (UTC) |  | Instant of update for an event in panel 4. This will be used for Event Interval functionality. |

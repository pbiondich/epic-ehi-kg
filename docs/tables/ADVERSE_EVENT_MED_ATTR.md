# ADVERSE_EVENT_MED_ATTR

> This table stores medication attribution information about an adverse event.
...
| 4 | `MED_ATTRIBUTION_C_NAME` | VARCHAR | org | The attribution level category ID for the corresponding medication to the adverse event. |

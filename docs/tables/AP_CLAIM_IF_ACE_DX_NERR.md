...
| 4 | `NUM_ERR_THIS_DX` | VARCHAR |  | The number of errors for this diagnosis field from Ambulatory Code Editor (ACE) output fields for ICD-9-CM diagnosis edits. |

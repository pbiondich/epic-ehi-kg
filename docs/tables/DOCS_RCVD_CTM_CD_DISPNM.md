# DOCS_RCVD_CTM_CD_DISPNM

> This table stores the display name of all the mapping codes for one care team member reference ID.
...
| 6 | `DISPLAY_NAME` | VARCHAR |  | The display names of all the mapping codes for one care team reference ID |

# AP_CLAIM_IF_SVC_GRP_RECUR

> This table contains the Recurring Service Flag value returned from the third party interface.
...
| 5 | `RECURRING_SVCS_FLAG` | VARCHAR |  | The Recurring Service Flag value returned from the third party interface. |

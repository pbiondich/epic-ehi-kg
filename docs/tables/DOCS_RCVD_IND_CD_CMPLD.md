# DOCS_RCVD_IND_CD_CMPLD

> This table stores the data type, coding system, and code data received for a medication indication reference ID.
...
| 6 | `DATA_TYPE_C` | INTEGER |  | The mapping data type. |
